...
:description: The Lisk Hello world tutorial covers how to create a custom transaction object based on the BaseTransaction interface, and how to register it with the node application.
:toc:
...
For the Hello world App, it is necessary to create a xref:customize.adoc[custom transaction object] `HelloTransaction`: +
