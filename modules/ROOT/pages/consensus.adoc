= Blockchain gonvernace
Mona Bärenfänger <mona@lightcurve.io>
:description: This section provides an overview of DPoS, forging, registering, voting and further helpful details regarding BFT.
:toc:
...
:url_pow_glossary: references/glossary.adoc#pow
:url_bft_glossary: references/glossary.adoc#bft
...
[NOTE]
====
During a forging round, no new calculations are required, which makes DPoS an extremely *energy-friendly* consensus algorithm, compared to "mining", which is the analog process for blockchains that run with Proof of Work xref:{url_pow_glossary}[(PoW)].
