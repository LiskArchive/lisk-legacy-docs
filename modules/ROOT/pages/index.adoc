...
How to rebuild from a snapshot, and how to create your own snapshots is explained in the Administration section for each <<_lisk-core-distributions, distribution>> of Lisk Core.
