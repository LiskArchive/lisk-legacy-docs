...
.nft/blockchain-app/nft_module/transactions/
[source,bash]
----
touch create_nft.js <1>
----
<1> Create a new file `create_nft.js` inside the `transactions/` folder.
