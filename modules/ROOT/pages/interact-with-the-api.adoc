...
:description: The "Interact with the network" page covers interacting with the blockchain network using other applications such as Lisk Desktop and Lisk Explorer.
