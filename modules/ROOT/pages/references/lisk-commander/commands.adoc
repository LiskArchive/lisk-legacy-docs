...
:url_aes_glossary: references/glossary.adoc#aes-256-cbc-advanced-encryption-standard
...
VERSION
  lisk-commander/5.1.0 darwin-x64 node-v12.20.1
...
ARGUMENTS
  PROJECTPATH  [default: /Users/mona/git/test-app] Path to create the project.
