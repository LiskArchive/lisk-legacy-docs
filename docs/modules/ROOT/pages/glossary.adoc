...
An active validator is an account that registered as validator and can generate new blocks in the next block generation round for the Lisk mainchain, or for a sidechain with DPoS as validator selection algorithm.
