...
:url_protocol_block_forgers: {v_protocol}@lisk-sdk:protocol:blocks.adoc#forgers
:url_protocol_dpos: {v_protocol}@lisk-sdk:protocol:consensus-algorithm.adoc
:url_protocol_delegate_selection: {v_protocol}@lisk-sdk:protocol:consensus-algorithm.adoc#delegate_selection
:url_protocol_blocks_punishment: {v_protocol}@lisk-sdk:protocol:consensus-algorithm.adoc#punishment
