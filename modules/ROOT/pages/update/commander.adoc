= Lisk Core Update with Lisk Commander
...
:url_installation_of_core: setup/commander.adoc/installation_of_lisk_core
...
----
<1> Exchange `INSTANCE` with the name of your Lisk Core instance, which you chose during the xref:{url_installation_of_core}[Installation of Lisk Core].
--
Testnet::
+
--
...
You can refer to our {url_binary_release}[binary release] for the file naming convention.
