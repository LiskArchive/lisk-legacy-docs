...
:url_commander_commands_createaccount: reference/lisk-commander/commands/index.adoc#create_account
:url_commander_commands_delegateregistration: reference/lisk-commander/commands/index.adoc#delegate_registration
