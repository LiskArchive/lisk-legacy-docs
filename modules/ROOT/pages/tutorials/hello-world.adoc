...
:url_github_hello: https://github.com/LiskHQ/lisk-sdk-examples/tree/v4/archive/3.x/hello_world
:url_github_hello_index: https://github.com/LiskHQ/lisk-sdk-examples/blob/v4/archive/3.x/hello_world/index.js
:url_github_hello_tx: https://github.com/LiskHQ/lisk-sdk-examples/blob/v4/archive/3.x/hello_world/transactions/hello_transaction.js
