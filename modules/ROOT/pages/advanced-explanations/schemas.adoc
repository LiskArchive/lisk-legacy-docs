...
To conveniently decode and encode the data structures stored on the blockchain, such as such as blocks, transactions, account state, and chain state, use the `codec` package.
The `codec` library can be imported from the following NPM packages:
