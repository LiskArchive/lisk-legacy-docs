...
The commands page covers how to create and show accounts, hash onion outputs, and provides examples of all relevant command messages, including the Network identifier and how to manage passphrases.

== Account
How to create and show commands relating to Lisk accounts are described here and examples are provided below.
...
It displays the Lisk address, the address as a binary string, and both the publickey and privatekey that belong to the entered passphrase:
...
How to creates a hash onion output to be used by a forger is shown below:
...
The relevant commands relating to user messages are shown below in this section.
...
This command uses the Lisk Elements passphrase module to encrypt a message that is provided for a given public key using a randomly generated nonce.
...
The public key, signature, and message are required here.
...
This displays the Network identifier based on the payloadhash of the xref:{url_guides_config_genesis_block}[genesis block] of the network.
...
The relevant commands relating to Lisk passphrases are shown in this section.
