...
:url_validator_nodes: run-blockchain/become-a-validator.adoc
:url_staking: run-blockchain/staking.adoc
:url_staking: https://lisk.com/learn/guides/stake-lsk-tokens
...
xref:{:url_validator_nodes}[Validator nodes] fulfill a very important role in the network and therefore, they require certain additional configurations regarding enabling block generation and higher security measures, as compared to regular nodes.
...
=== Enabling block generation in the public betanet
...
Staking can be defined as the process of using your LSK tokens in order to determine who secures the network, which can be achieved by voting with your own tokens.
By performing staking it is possible to earn rewards, therefore giving the node operator the incentive to perform this.

To acquire a more in-depth overview of staking and how to earn additional LSK tokens within the Lisk network, please see the xref:{url_staking-guide}[staking guide].
