...
:toc:
:page-aliases: administration/source.adoc
...
[TIP]
====
For creating xref:{url_core_snapshots}[snapshots] in the most convenient manner, it is recommended to use Lisk Core from the xref:{url_admin_binary}[Lisk Core application].
