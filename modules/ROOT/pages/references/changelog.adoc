...
The registration of a multisignature account has changed as displayed in the code snippet below.
...
The voting process has changes as shown in the code snippet below.
