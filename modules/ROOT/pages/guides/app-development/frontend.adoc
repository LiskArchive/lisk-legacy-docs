...
Now update the file to include the above defined React components and to build a basic navigation.
...
NOTE: It is also needed to start the corresponding blockchain application, if it is not running already.
