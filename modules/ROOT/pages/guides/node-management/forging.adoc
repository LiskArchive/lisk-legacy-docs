...
:url_endpoints: references/lisk-framework/http-api-plug-in.adoc#list-of-endpoints
...
----
//@ Mona: Could you please check this code snippet above?
...
//@ Mona, can you help with this code snippet please?
...
// Do we need to add in the 'List of endpoints' here, as they are already in the references under HTTP API plugin

=== List of Endpoints

All possible API endpoints including the descriptions, details and examples can be found here in the xref:{url_endpoints}[list of endpoints] in the HTTP API plugin section.

=== updateForgingStatus

IMPORTANT: *Please note: This is a private endpoint ONLY authorized to whitelisted IPs*.

After inputting the correct password, forging will be enabled or disabled for the delegate of this particular node.
