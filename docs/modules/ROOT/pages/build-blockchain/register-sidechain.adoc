...
It is requested to receive the following values:
...
* `height` (Sidechain): The current height of the sidechain is used to get the data about the currently active sidechain validators.
