...
Additional steps might be required for more complex blockchain applications (e.g. releasing additional software such as Middllewares between the frontend and the blockchain application).
