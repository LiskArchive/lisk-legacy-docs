...
:url_build_quickstart: 5.2@lisk-sdk::quickstart.adoc
...
:url_sdk: 5.2@lisk-sdk::index.adoc
:url_core: 3.1@lisk-core::index.adoc
:url_service: 0.6@lisk-service::index.adoc
