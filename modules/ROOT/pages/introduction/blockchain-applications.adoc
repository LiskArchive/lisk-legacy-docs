...
:url_protocol_consensus: protocol:consensus.adoc#voting_and_weight
...
* is handled in xref:{url_explanations_off_chain}[].
...
For more information abouut the communication architecture, check out the xref:{url_advanced_communication}[advanced explanation] of the communication architecure.
