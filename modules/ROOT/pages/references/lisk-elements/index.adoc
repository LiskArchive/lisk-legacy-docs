...
[source,html]
----
<script src="https://js.lisk.com/lisk-client-5.2.2.js"></script>
----
...
[source,html]
----
<script src="https://js.lisk.com/lisk-client-5.2.2.min.js"></script>
----
...
For example, to load the minified version 5.2.2 of Lisk Elements, include the following script which will then expose the `lisk` variable:
