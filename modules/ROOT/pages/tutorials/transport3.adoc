= Supply Chain Tutorial Part 3: Next steps
...
After completion of part 2, the set up should appear as shown below in the following diagram: xref:tutorials/transport2.adoc[Part 2: A simple supply chain tracking system]:
...
Once a new node is set up, update the API endpoint in the https://github.com/LiskHQ/lisk-sdk-examples/blob/development/transport/client/app.js#L14[client] application to target the new node as shown below:
