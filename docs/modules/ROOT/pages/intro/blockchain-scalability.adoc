...
In fact this approach is used by Lisk in order to improve scalability.
...
DPoS also possesses further key benefits of being a highly decentralized and efficient consensus mechanism, coupled with having fast transactions and a high level of security, ensuring it is well placed for any Web3-based projects.
