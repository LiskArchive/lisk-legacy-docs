...
This is how the network should look like after step 2.3:
...
TIP: How to replace the genesis delegates with real delegates is covered in the next section <<_2_4_3_replace_dummy_delegates_with_real_ones, Replace dummy delegates with real ones>>.
