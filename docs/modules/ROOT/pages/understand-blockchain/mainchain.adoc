...
<<table1,Table 1>> below compares Mainnet and Testnet mainchain and their specific properties and configurations:
...
The native token for the Lisk Mainchain is *LSK*, pronounced like "Lisk".
