...
:url_module_apis: api/lisk-node-rpc.adoc
...
In addition, further information can be found in the xref:{url_module_apis}[APIs section] regarding all RPC, module, and Lisk Service related APIs.
