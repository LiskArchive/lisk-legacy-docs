...
NOTE: It is recommended to view the xref:tutorials/transport.adoc#_general_procedure[diagram on the Introduction page], which will help the user to have an overiew of the workshop.
