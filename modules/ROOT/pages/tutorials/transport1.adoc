...
:description: Part 1 of the Lisk Transport tutorial describes how to implement a blockchain application that tracks sensor data on the blockchain. For this, a raspberrz pi is used as IoT device that collects the sensor data and communicates with the blockchain network.
:toc: preamble
...
Alternatively, please check the xref:tutorials/hello-world.adoc#_3_create_a_new_transaction_type[tutorials] in the Lisk documentation.
