...
:url_build_quickstart: v5@lisk-sdk::quickstart.adoc
...
:url_sdk: v5@lisk-sdk::index.adoc
:url_core: v3@lisk-core::index.adoc
:url_service: v0.6@lisk-service::index.adoc
