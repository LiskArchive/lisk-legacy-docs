...
If you consider gaining an active forging position on the Lisk Mainnet, please be aware that the Lisk DPoS requires to xref:{url_glossary_selfvote}[self stake] with a certain amount of your own tokens.
...
This gives delegates who don't have enough stakes weights the chance to profit from forging awards as well.

The random selection of the two standby delegates is proportional to their individual stake weight, meaning delegates with higher stake weight have a higher chance of getting selected.
