...
rm -rf ~/.nvm
----
Add a new session and set the iTerm to open the Intel mode and set a shortcut key
Open a terminal in the Intel mode
...
When using the latest MACs this allows mixing the Intel software with the native ARM compilations.
