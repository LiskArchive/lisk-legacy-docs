...
The aim of this documentation is to provide a high-level overview of the protocol. A complete technical specification of most parts of the protocol is provided in the respective https://github.com/LiskHQ/lips[Lisk Improvement Proposals]._
...
The Lisk protocol defines an account-based blockchain with a set of default transactions that are used to modify the accounts state.
