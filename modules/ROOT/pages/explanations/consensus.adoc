...
Lets assume a user holds an account with a balance of 150 tokens.
The user has voted before with 50 tokens for the delegate with address `7700165370820050502L`.

He now wants to remove the 50 tokens from the voteweight of delegate `7700165370820050502L` again.
At the same time, he wants to use the currently available 100 tokens to vote for 2 other delegates.

Be aware that the user cannot reuse the 50 tokens
