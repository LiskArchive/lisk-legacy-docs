...
[source,json]
----
curl --location 'http://devnet-service.liskdev.net:9901/api/v3/legacy?publicKey=b1d6bc6c7edd0673f5fed0681b73de6eb70539c21278b300f07ade277e1962cd'
----
--
RPC-WS::
+
...
[source,json]
----
curl --location 'http://devnet-service.liskdev.net:9901/api/v3/network/peers?ip=210.239.23.62'
----
--
RPC-WS::
+
...
[source,json]
----
curl --location 'http://devnet-service.liskdev.net:9901/api/v3/network/status'
----
--
RPC-WS::
+
...
[source,json]
----
curl --location 'http://devnet-service.liskdev.net:9901/api/v3/network/statistics'
----
--
RPC-WS::
+
...
[source,json]
----
curl --location 'http://devnet-service.liskdev.net:9901/api/v3/schemas'
----
--
RPC-WS::
+
...
|`status`
|String
|`registered`, `active`, `terminated`, `unregistered`
|empty
|Can be expressed as CSV.
...
[source,json]
----
curl --location 'http://devnet-service.liskdev.net:9901/api/v3/blockchain/apps'
----
--
RPC-WS::
+
...
[source,json]
----
curl --location 'http://devnet-service.liskdev.net:9901/api/v3/blockchain/apps/statistics'
----
--
RPC-WS::
+
...
[source,json]
----
curl --location 'http://devnet-service.liskdev.net:9901/api/v3/index/status'
----
--
RPC-WS::
+
...
[source,json]
----
curl --location 'http://devnet-service.liskdev.net:9901/api/v3/invoke' \
--header 'Content-Type: application/json' \
--data '{
...
[source,json]
----
curl --location 'http://devnet-service.liskdev.net:9901/api/v3/blockchain/apps/meta/list'
----
--
RPC-WS::
+
...
[source,json]
----
curl --location 'http://devnet-service.liskdev.net:9901/api/v3/blockchain/apps/meta/'
----
--
RPC-WS::
+
...
[source,json]
----
curl --location 'http://devnet-service.liskdev.net:9901/api/v3/blockchain/apps/meta/tokens'
----
--
RPC-WS::
+
...
[source,json]
----
curl --location 'http://devnet-service.liskdev.net:9901/api/v3/blockchain/apps/meta/tokens/supported?chainID=00000000'
----
--
RPC-WS::
+
...
[source,json]
----
curl --location 'http://devnet-service.liskdev.net:9901/api/v3/market/prices'
----
--
RPC-WS::
+
...
// [source,json]
// ----
// curl --location 'http://betanet-service.lisk.com/api/v3/transactions/export?address=lskdwsyfmcko6mcd357446yatromr9vzgu7eb8y99'
// ----
// --
// RPC-WS::
// +
