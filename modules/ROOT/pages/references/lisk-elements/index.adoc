...
[source,html]
----
<script src="https://js.lisk.com/lisk-client-5.1.3.js"></script>
----
...
[source,html]
----
<script src="https://js.lisk.com/lisk-client-5.1.3.min.js"></script>
----
...
For example, to load the minified version 5.1.3 of Lisk Elements, include the following script which will then expose the `lisk` variable:
