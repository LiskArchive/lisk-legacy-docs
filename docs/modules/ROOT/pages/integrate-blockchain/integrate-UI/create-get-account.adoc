...
Start both the xref:{url_start_client}[*hello_client*] and the {url_start_frontend}[*hello_frontend*^], and then click on the *Account->Create Account* option in the menu bar.
