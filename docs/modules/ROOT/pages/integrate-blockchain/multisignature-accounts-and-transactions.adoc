...
[.float-group]
--
image:integrate-blockchain/multisig/06-sign-multisig.png[,300,role="right"]
...
[.float-group]
--
image:integrate-blockchain/multisig/07-add-json.png["Sign",300,role="right"]
This will open a new window where you are able to paste the JSON you received.
--
[.float-group]
--
image:integrate-blockchain/multisig/08-review-params.png["Sign",300,role="right"]
...
[.float-group]
--
image:integrate-blockchain/multisig/09-share.png["Sign",300,role="right"]
...
[.float-group]
--
image:integrate-blockchain/multisig/12-send.png[,300,role="right"]
