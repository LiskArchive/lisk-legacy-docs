...
Within the Lisk ecosystem the solution for enabling blockchain networks to achieve interoperability, and interact with other blockchain networks involves utilizing a separate blockchain as a bridge to facilitate the exchange of data.
...
The Lisk interoperability solution facilitates communication with other Lisk chains built within the Lisk ecosystem, via the concept of xref:{url_cross_chain_cert}[cross-chain] certification.
