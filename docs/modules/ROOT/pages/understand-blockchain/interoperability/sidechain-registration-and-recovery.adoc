...
.Recovery process from the mainchain.
image::understand-blockchain/interop/recovery_mainchain.png[align="center",width=500]
...
It is therefore recommended to use a recovery service if available, see <<recovery-as-a-service>> for more information on the topic.
