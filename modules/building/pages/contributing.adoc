...
** Use template `Improvement` for content that needs improvement.
...
. Communicate you want to work on an issue in the Sprint planning meeting.
...
Always add the issues and PRs to their corresponding project(s).
