...
:description: All config file handling including the configuration of Lisk Core is covered here.
:toc:
...
Only the values required to be updated are necessary, as for all other options the pre-defined values will be used as described in the <<order, Config Load Order>> section.
