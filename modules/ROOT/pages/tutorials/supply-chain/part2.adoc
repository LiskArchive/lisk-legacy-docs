...
:description: Part 2 of the Lisk supply chain tutorial describes how to implement a blockchain application that tracks sensor data on the blockchain. To accomplish this, a raspberry pi is used as the IoT device that collects the sensor data and communicates with the blockchain network.
:toc: preamble
...
:url_customize_interface: guides/customize-transactions.adoc#interface
