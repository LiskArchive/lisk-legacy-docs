...
Most cryptocurrencies utilize asymmetric encryption. For example, Ethereum uses asymmetric crypotography with the public-private key pair as described further in this section.

To delve a bit further into cryptography in blockchain, further more detailed information can be found {url_crypto}[here^].
