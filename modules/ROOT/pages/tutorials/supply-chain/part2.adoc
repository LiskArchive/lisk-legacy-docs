...
:url_iot_glossary: references/glossary.adoc#iot
...
If something unexpected is detected by the xref:{url_iot_glossary}[IoT] app, it will create a transaction object, sign it, and send it to the network.
