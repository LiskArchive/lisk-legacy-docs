...
:description: The Lisk Core Commander application setup describes all options including pre-install, install & post-install to manage your Lisk Core node.
:toc:
:v_sdk: master
:v_core: 2.1.5
...
* `--lisk-version=2.0.0`
* `--lisk-version=2.1.3`
| Define the exact version required to upgrade Lisk Core.
