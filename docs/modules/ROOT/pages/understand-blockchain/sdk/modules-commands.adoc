...
The module endpoints are usually defined in a file called `endpoints.ts` inside of the folder of the respective module.
...
Methods are called from other modules or by the module itself, if certain module-specific data is desired to get or set in the blockchain.
