...
Be aware, that the correct reading and writing of the data to the database is already part of the Lisk SDK software testing and hence, it is not necessary to test it again for your new custom transaction.
