...
This command broadcasts the signature to the network.
The command takes one of the required parameters:
...
The following command below creates and signs a type 2 transaction, which will register the account as a delegate candidate if it is broadcast to the network.
