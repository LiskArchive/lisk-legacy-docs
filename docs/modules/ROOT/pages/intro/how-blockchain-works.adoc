...
This methodology is highly beneficial as the nodes broadcast their new transactions which results in synchronizing their local copies of the blockchain.
