...
The following command will return a config object in the console.
The object can be copy-pasted directly into the application configuration liek described below.
...
To check the forging status of a Lisk Core node do the following:
