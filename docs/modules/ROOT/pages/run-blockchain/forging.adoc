...
:url_commander_commands: {docs_sdk}reference/lisk-commander/commands.adoc
:url_framework_dashbobardplugin: {docs_sdk}reference/lisk-framework/dashboard-plugin.adoc
:url_elements: {v_sdk}@lisk-sdk::reference/lisk-elements/index.adoc
:url_elements_crytpography: {docs_sdk}reference/lisk-elements/cryptography.adoc
:url_explanations_consensus: {docs_sdk}reference/lisk-framework/dpos-module.adoc#forging
:url_explanations_consensus_register: {docs_sdk}reference/lisk-framework/dpos-module.adoc#delegate_registration
:url_references_cli_forgingconfig: {docs_sdk}reference/application-cli.adoc#forgingconfig
:url_references_cli_forgingenable: {docs_sdk}reference/application-cli.adoc#forgingenable
