...
If you have added the lisk-migrator to the PATH like described in section <<setting-up-the-lisk-migrator>> you can start the migration script by runnong the following command in the terminal:
+
