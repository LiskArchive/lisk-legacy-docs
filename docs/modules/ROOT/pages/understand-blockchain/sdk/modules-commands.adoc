...
:url_build_app: build-blockchain/create-sidechain-app.adoc
...
A module is a discrete component that contains blockchain-related business logic. This logic can be related to a specific domain or a topic of a Sidechain Application{fn_sidechain_glossary} (sApp).

Modules can be added to a sApp by registering them to the sidechain client{fn_sidechain_client_glossary}.
