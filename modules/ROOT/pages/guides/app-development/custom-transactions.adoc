...
:url_{v_protocol}@lisk-sdk:protocol: {v_protocol}@lisk-sdk:protocol:index.adoc
:url_protocol_transactions: {v_protocol}@lisk-sdk:protocol:transactions.adoc
:url_protocol_transactions_pool: {v_protocol}@lisk-sdk:protocol:network.adoc#pool
