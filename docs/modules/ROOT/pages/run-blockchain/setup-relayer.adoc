...
With these configurations, the details such as the receiving chain’s chainID and it's IPC path or WS URL, CCU frequency, encrypted private key, etc. can be set.
