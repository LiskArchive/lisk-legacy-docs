...
[TIP]
====
https://github.com/LiskHQ/lisk-sdk-examples/blob/development/transport/transactions/solutions/light-alarm.js[Please see the solutions at /transactions/solutions] for the custom transaction types.
...
For more details please check the <<_task_implement_validateasset, explanation below>>.
...
TIP: Please see the Lisk Documentation for an xref:customize.adoc#_the_basetransaction_interface[overview about the required methods for custom transactions]
...
Alternatively, please see the xref:tutorials/hello-world.adoc#_3_create_a_new_transaction_type[tutorials] in the Lisk documentation.
