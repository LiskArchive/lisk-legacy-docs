...
It can be thought of as an instance of a blockchain which is used for testing purposes and consists of the same version of the mainnet underlying software.
