...
TOPICS
  ...
  blskey         Returns the bls public & private keys corresponding to the given passphrase.
...
COMMANDS
  ...
  help          Displays help for dpos-mainchain.
...
COMMANDS
  ./bin/run transaction:create  Create a transaction that can be broadcasted to the network. Note: fee and amount should be in Beddows!!
