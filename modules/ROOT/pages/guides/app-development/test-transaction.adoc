...
:url_github_hello_world_tx: https://github.com/LiskHQ/lisk-sdk-examples/blob/v4/hello_world/transactions/hello_transaction.js#L49
:url_github_hello_world_tx_test: https://github.com/LiskHQ/lisk-sdk-examples/blob/v4/hello_world/transactions/test/hello_transaction.test.js
