...
Depending on their preferences, node operators may wish to use <<_a_write_scripts_in_javascript,Lisk Elements>>, <<_b_use_the_command_line,Lisk Commander>> or a graphical interface such as <<use_lisk_desktop,Lisk Desktop>>.
