...
* Interoperability is another perk of Lisk. Various side chains registered to the main chain can communicate with each other and exchange value through the main chain.  
