...
* `receivingChainID`: Enter the chain ID of the respective sidechain you want to send LSK to.
...
Once the first CCU was sent successfully from sidechain to mainchain, the sidechain is now activated and interoperable with the mainchain and other sidechains the Lisk ecosystem.