...
:v_sdk: master
:v_core: 2.1.3
:url_sdk_commander_setup: lisk-commander/index.adoc#_setup
:url_sdk_commander_setup: lisk-commander/installation-instructions/lisk-commander.adoc
...
Setup and manage your Lisk node conveniently with Lisk Commander. xref:{sdk_commander_setup}[lisk-commander/index.adoc#_setup]
