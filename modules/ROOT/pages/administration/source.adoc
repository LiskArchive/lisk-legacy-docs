...
____
For creating xref:introduction.adoc#_snapshots[snapshots] the most
convenient way, it is recommended to use Lisk Core from
xref:administration/binary.adoc#_create_snapshot[binary distribution]. Just execute the
...
xref:introduction.adoc#_snapshots[snapshot]. The command blocks below
