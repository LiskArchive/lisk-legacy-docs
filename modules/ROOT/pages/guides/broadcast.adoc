...
:url_tutorials_hello: guides/index.adoc#_the_hello_world_app
...
+
--
The `HelloTransaction` of the xref:{url_tutorials_hello}[Hello World app] is used as an example here.
...
+
--
The `HelloTransaction` from the xref:{url_tutorials_hello}[Hello World guide] is used as an example here.
