...
//TODO: Verify correct position of this paragraph (maybe it is too early position right now)
...
//TODO: Verify correct position of this paragraph (maybe it is too early right now)
=== Validator info data
