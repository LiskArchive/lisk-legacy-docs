...
To run and manage a node in the future, create a separate `lisk` user by executing the following command:
...
To install the NPM package {url_npm_sdk}[lisk-sdk^], execute the following command:
