...
All these parameters can be prepared in a JSON file, which we call `sidechain_reg_params.json` in this example.

[TIP]
====
To conveniently prepare the required parameters for the sidechain registration message, check out the following script in the lisk-sdk-examples repository: {url_github_exmaples_sidechaintegistration}[sidechainRegistration.ts^].

It can be used like so: `node sidechainRegistration.ts NAME CHAINID THRESHOLD`

.Example
[source,bash]
----
node sidechainRegistration.ts sidechain1 00000008 65
----
====
...
In this case, the sidechain has to be restarted completely, or it needs to perform a hardfork to change the chain ID, and resubmit the "Register Sidechain" transaction with a new value for the chain ID.
====

To check if a certain chain ID is still available in the network, call RPC endpoint `interoperability_isChainIDAvailable` with the chain ID as parameter.
...
TIP: The xref:{url_api_rpc_getnodeinfo}[system_getNodeInfo] node endpoint can be requested, to retrieve the latest block height.
...
[IMPORTANT]
====
The validator list needs to be *alphabetically sorted* after the `blsKey`, to be a valid parameter.

An example how to sort the validator list can be found in the example script {url_github_exmaples_sidechaintegistration}[sidechainRegistration.ts^].
====
...
The transaction parameters are now prepared in `sidechain_reg_params.json` and we can proceed to create and post the transaction in the next section.
...
As a response, the CLI will ask for the `passphrase` of the mainchain node.
Once the correct `passphrase` is passed, the transaction will be returned in hex format:
...
[source,bash]
----
./bin/run transaction:send 
----
====
...
TIP: To retrieve the BFT parameters of all mainchain validators, invoke the `consensus_getBFTParameters` endpoint on the *mainchain node*.
...
This file can be generated for a specific validator with the `keys:create` CLI command, by providing the passphrase.
