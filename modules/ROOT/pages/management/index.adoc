...
2. xref:{url_commander}[*Commander application commands*] -   The Lisk Commander application offers an alternative method to install and further manage Lisk Core.
3. xref:{url_docker}[*Docker image commands*] -  Docker image provides the options to run Lisk nodes on other platforms.
