...
:glossary-lsk: 'The token used in the Lisk Mainnet.'
...
This converts amounts in Beddows, (the smallest denomination) to the amounts in one glossterm:LSK[{glossary-lsk}].
