...
:description: A reference of all Lisk Commander application commands to manage Lisk Core via the command-line.
:page-aliases: administration/commander.adoc
:toc:
:page-next: /lisk-core/v2/management/configuration.html
:page-previous: /lisk-core/v2/setup/commander.html
:page-next-title: Handle config files
:page-previous-title: Commander application
...
This section covers how to work with the commander application installation of Lisk Core.
