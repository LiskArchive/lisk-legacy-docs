...
The Lisk interoperability solution is designed to facilitate communication via the concept of xref:{url_cross_chain_cert}[cross-chain] certification.
In essence, cross-chain certification involves submitting information from one chain to another, through a signed object known as a certificate.
