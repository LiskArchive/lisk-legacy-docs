...
OPTIONS
  -p, --passphrase=passphrase  Specifies a source for your secret passphrase. Command will prompt you for input if this option is not set.
                                Examples: --passphrase='my secret passphrase' (should only be used where security is not important)
...
==== forging:disable
Disables forging for a given delegate address.
...
==== forging:enable
Enables forging for a given delegate address.
