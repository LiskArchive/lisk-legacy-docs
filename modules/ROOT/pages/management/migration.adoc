...
* Machines with minimum 4 GB RAM for Mainnet
* Machines with minimum 2 GB RAM for Testnet
====
...
First ensure, that Lisk Core wont start again by removing the existing cronjob:
