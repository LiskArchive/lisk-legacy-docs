...
It's an optional value, and is only used if the user passes a value higher than the minimum calculated fee.
In that case the the minimum calculated fee is overriden with the value passed with the `ccuFee` property.
|100000000
