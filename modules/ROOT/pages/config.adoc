...
The application will use the default configuration options in case a custom config option is not specified.
...
By default a configuration will look like this:
...
All the aforementioned configurations can be tweaked as per necessity and can be then passed as a `customConfig` to the `Application` instance. 
