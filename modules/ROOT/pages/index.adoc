...
The {url_github_sdk}[Lisk SDK^] is an easy to use and reliable software development kit designed for building blockchain applications which are compatible with the xref:{url_protocol}[Lisk Protocol].
...
The most relevant guides for beginners are listed below:
...
This is a good location to look up certain topics in order to gain a deeper understanding, or to further explore the SDK in a scientific direction.
