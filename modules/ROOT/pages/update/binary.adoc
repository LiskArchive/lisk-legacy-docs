...
In case you created custom configurations inside the `lisk-core/` folder, make sure to copy or move them out of the `lisk-core/` folder before removing it in the next step.
...
For updating to 3.0.2, most importantly, ensure to include the new property `unlockFixHeight` in the configuration.
