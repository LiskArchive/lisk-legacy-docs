...
On this page, you will learn how to create a new sidechain application{fn_sidechain_glossary} (sApp) with the Lisk SDK.
...
The default modules provide basic sidechain functionality required by a sidechain client to work.
...
It is used to create the genesis block for the sidechain.
