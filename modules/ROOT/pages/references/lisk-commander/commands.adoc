...
This command uses glossterm:AES-256-CBC[{glossary-aes}] to encrypt your secret passphrase under a password you provide using a randomly generated initialisation vector (IV).
