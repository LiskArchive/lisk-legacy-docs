...
The above commands should be enough to install Redis ready to use with Lisk Service.
...
If you haven't already, clone the {url_github_service}[lisk-service^] GitHub repository and then navigate into the project folder and check out the latest release.
