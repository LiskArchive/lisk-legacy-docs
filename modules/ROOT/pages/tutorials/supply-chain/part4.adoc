...
The next steps after the initial development of the application are described here.
...
Alternatively, permit the network know the current location of the packet by transmitting the GPS location in a certain time interval.
