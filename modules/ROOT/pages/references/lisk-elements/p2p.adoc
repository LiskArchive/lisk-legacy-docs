...
:url_crud_glossary: references/glossary.adoc#crud-create-read-update-delete
:url_rpc_glossary: references/glossary.adoc#rpc-remote-procedure-call
...
* Impose rate limits on messages and xref:{url_rpc_glossary}[RPC] requests, and apply a penalty for misbehaviour.
