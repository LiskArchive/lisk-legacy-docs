...
:url_guides_genesis_update: guides/app-development/genesis-block.adoc#including-the-account-asset-schemas
...
====
If a module includes an account schema, it is necessary to xref:{url_guides_genesis_update}[update the genesis block] after registering the module to the application.
====
