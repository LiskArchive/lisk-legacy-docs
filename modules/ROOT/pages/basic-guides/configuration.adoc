...
TIP: To see a full list of all constants and their predefined values, please see the file https://github.com/LiskHQ/lisk-sdk/blob/development/framework/src/application/schema/constants_schema.js.
