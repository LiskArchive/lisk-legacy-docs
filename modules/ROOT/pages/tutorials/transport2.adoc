...
.The different actors in Lisk Transport can be seen below:
[source,json]
----
{
  "carrier": {
...
It should display the following error listed below:
...
TIP: Move on to xref:tutorials/transport3.adoc[section 3: Next steps] to find additional explanations and possible next steps.
