...
xref:{v_sdk}@lisk-sdk::lisk-commander/introduction.adoc#_setup[installation instructions].
...
have a look at our xref:administration/binary.adoc[Administration Section].
