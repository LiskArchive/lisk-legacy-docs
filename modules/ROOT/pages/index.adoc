...
To get started in Testnet, get your free Testnet LSK from the {url_faucet_testnet}[Testnet Faucet].
...
The releases for Lisk Core 3.0, 4.0 and 5.0 will all be published on Betanet first.
After the new versions have gradually been released on the Betanet (each version will result in a new hard fork in the network), the next step is to do one big release to the Testnet and finally to Mainnet, which will include all changes in Lisk SDK 3.0, 4.0 and 5.0.
Like this, the number of hard forks in the testnet and mainnet is reduced significantly.
...
To get started in Betanet, get your free Betanet LSK from the {url_faucet_betanet}[Betanet Faucet].

To connect to Testnet via {url_lisk_desktop}[Lisk Desktop], simply enable the "Network Switcher" in the Settings.
