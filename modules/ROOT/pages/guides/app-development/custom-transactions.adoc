...
[TIP]
====
For more information on creating your own custom transactions, please refer to the guides

* xref:{}[Interact with the API]
** xref:{}[Broadcast a transaction]
* xref:{}[Connect a frontend]
