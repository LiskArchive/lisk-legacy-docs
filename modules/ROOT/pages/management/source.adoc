...
:description: The Lisk Core Source commands describes all relevant commands to manage Lisk Core with pm2.
:toc:
...
:url_admin_binary: administration/binary.adoc#create_snapshot
