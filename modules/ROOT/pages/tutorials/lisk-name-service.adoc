...
:url_bapps_frontend: introduction/blockchainn-application.adoc#frontend-backend
...
Go back to the index pagee of the LNS Dashboard and search for a new domain name to add to your account.
...
In the screennshot, we search for the domain `awesome.lsk`, and luckily, it isn't taken, yet.

image:tutorials/lns/ui-search-results.png[UI search results,200,100]

Click on the `Register` link to opeen the dialog to register the domain.
...
T%he search results should now inform you that this domain name is already reserved.
