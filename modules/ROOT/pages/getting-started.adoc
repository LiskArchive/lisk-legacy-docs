...
An installation performed from xref:{url_source}[source] enables a developer to work on the newest codebase for Lisk Core, which may not have been tagged for a release yet.
