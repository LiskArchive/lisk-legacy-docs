...
== `pos_getConstants`
Returns the constants used by PoS module.
...
== `pos_getLockedReward`
Returns the amount of rewards in the specified validator's account that is locked in order to be shared to the stakers.
...
[source,bash]
----
lisk-core endpoint:invoke pos_getLockedReward '{"address":"lskzytpy82c8xtkpopchzee3vydza4cvjvcsa4fv3", "tokenID": "0200000000000000"}' --pretty
----
...
[source,bash]
----
lisk-core endpoint:invoke pos_getClaimableRewards '{"address":"lskzytpy82c8xtkpopchzee3vydza4cvjvcsa4fv3"}' --pretty
----
...
[source,bash]
----
lisk-core endpoint:invoke pos_getExpectedSharedRewards '{"validatorAddress": "lskzytpy82c8xtkpopchzee3vydza4cvjvcsa4fv3", "validatorReward": "500000000", "stake":"1000000000" }' --pretty
----
