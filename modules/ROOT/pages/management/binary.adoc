...
PM2 is bundled with the Lisk Core Binary distribution and will be available after <<update_path, Updating the PATH environment>>.
For more information, how to manage your Node with PM2, please see the xref:{url_admin_source}[Source Administration] page.

=== psql

The interactive terminal for postgreSQL is bundled with the Lisk Core Binary distribution and will be available after <<update_path, Updating the PATH environment>>.
