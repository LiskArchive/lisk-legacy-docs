...
--
NOTE: When using a MAC with Apple Silicon (M1) please adhere to the relevant following setup instructions below:
...
# It requires a little housekeeping to ensure the right paths are included in the profile.
