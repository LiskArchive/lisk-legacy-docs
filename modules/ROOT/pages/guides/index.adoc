...
:description: Main guides overview containing, configuration, custom transactions, front end and launch guides & an example using the 'Hello World' App.
:toc:
...
:url_protocol_block_time: ROOT::understand-blockchain/lisk-protocol/blocks.adoc#_block_time
:url_protocol_delegates: ROOT::understand-blockchain/lisk-protocol/consensus-algorithm.adoc#voting_and_weight
