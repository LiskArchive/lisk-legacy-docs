...
:description: Technical reference for the Signatures endpoints of the API Client package of Lisk Elements. It copmrises Usage examples, available parameters and example responses.
:toc:
:v_core: master
...
`signatureObject+`: See details in the xref:{v_core}@lisk-core::api.adoc[Core API documentation].
