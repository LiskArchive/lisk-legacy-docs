...
:description: How to write & run a test script and test a custom transaction, together with a unit test example.
:source-linenums-option:
:highlightjs-theme: solarized_dark
:url_github_hello_world: https://github.com/LiskHQ/lisk-sdk-examples/tree/development/archive/3.x/hello_world
:url_github_hello_world_tx: https://github.com/LiskHQ/lisk-sdk-examples/blob/development/archive/3.x/hello_world/transactions/hello_transaction.js#L53
:url_github_hello_world_tx_test: https://github.com/LiskHQ/lisk-sdk-examples/blob/development/archive/3.x/hello_world/transactions/test/hello_transaction.test.js
