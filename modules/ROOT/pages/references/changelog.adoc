...
For Multisignature registration transaction, `signatures` also contain additional signatures corresponding to the public keys participating in the multisignature account.
