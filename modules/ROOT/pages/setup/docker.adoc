...
Please refer to {url_docker_install}[https://docs.docker.com/engine/installation][[desktop]]
...
+
--
Please refer to {url_docker_install_mac}[docker_installation_for_mac].
...
+
--
Please refer to {url_docker_install_windows}[docker_installation_for_windows]
Please note that Docker for Windows includes Docker Compose.
--
Linux::
+
--
Please refer to {url_docker_install_linux}[docker_installation_for_linux]

To install Docker Compose, please refer to {url_docker_install_linux_compose}[install_docker_compose]

IMPORTANT: Configure Docker, so it can be run without `sudo` rights: {url_docker_linux_post_install}[linux_post_install]
...
Makefile provides a convenient way to xref:{url_docker_sync_snapshot}[sync_from_a_snapshot][[sync_from_a_snapshot]]:
