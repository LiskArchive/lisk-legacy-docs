...
[source,bash]
----
lisk-core endpoint:invoke chainConnector_getAggregateCommits '{"from":840, "to":1000}' --pretty
----
...
[source,bash]
----
lisk-core endpoint:invoke chainConnector_getBlockHeaders '{"from":840, "to":1000}' --pretty
----
...
[source,bash]
----
lisk-core endpoint:invoke chainConnector_getCrossChainMessages '{"from":840, "to":1000}' --pretty
----
