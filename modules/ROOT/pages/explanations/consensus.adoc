...
:url_protocol_blocks_rewards: {v_protocol}@lisk-sdk:protocol:blocks.adoc#rewards_and_fees
:url_protocol_dpos: {v_protocol}@lisk-sdk:protocol:consensus-algorithm.adoc#dpos
:url_protocol_bft: {v_protocol}@lisk-sdk:protocol:consensus-algorithm.adoc#lisk_bft
:url_protocol_delegate_selection: {v_protocol}@lisk-sdk:protocol:consensus-algorithm.adoc#delegate_selection
:url_protocol_fork_choice: {v_protocol}@lisk-sdk:protocol:consensus-algorithm.adoc#index-fork_choice_rule-1
:url_protocol_punishment: {v_protocol}@lisk-sdk:protocol:consensus-algorithm.adoc#punishment
:url_protocol_transactions_pom: {v_protocol}@lisk-sdk:protocol:transactions.adoc#pom
:url_protocol_transactions_delegate: {v_protocol}@lisk-sdk:protocol:transactions.adoc#delegate
:url_protocol_transactions_unlock: {v_protocol}@lisk-sdk:protocol:transactions.adoc#unlock
:url_protocol_transactions_vote: {v_protocol}@lisk-sdk:protocol:transactions.adoc#vote
