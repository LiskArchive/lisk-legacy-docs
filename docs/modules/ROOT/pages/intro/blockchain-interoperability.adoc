...
Despite their connection to the parent blockchain, sidechains employ distinct {url_consensus_algorithm}[consensus algorithms^] and possess unique native tokens.
