...
The default modules already come with a set of xref:{url_protocol_transactions}[default transactions], which can be sent to the blockchain application without writing any custom code.
