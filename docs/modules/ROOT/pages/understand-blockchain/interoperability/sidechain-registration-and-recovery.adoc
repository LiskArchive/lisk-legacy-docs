...
image::understand-blockchain/interop/sidechain-registration.png[]
...
=== Registration CCM
Every time that a sidechain is registered on th emainchain and vice versa, a corresponding "registration" CCM is created and appended to the chain outbox.
