...
:url_reference_dashboard: 6.0.0@lisk-sdk::reference/lisk-framework/dashboard-plugin.adoc
:url_reference_faucet: 6.0.0@lisk-sdk::reference/lisk-framework/faucet-plugin.adoc
