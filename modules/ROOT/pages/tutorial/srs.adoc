...
:url_statestore: 6.0.0@lisk-sdk::references/lisk-elements/chain.adoc#state-store
:url_references_token_module: 6.0.0@lisk-sdk::references/lisk-framework/token-module.adoc
...
First, create the folder for the blockchain application, initialize a new Node.js ptoject and install the xref:{url_lisk_sdk}[Lisk SDK] as dependency.
