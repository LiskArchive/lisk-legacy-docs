...
====
On this page, we dive deeper into the details of how cross-chain communication works in the Lisk ecosystem, by describing the different components and the general processes how state changes are executed across chains in the Lisk ecosystem.
