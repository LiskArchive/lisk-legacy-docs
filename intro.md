...
* [Intro](#lisk-mobile-documentation)
  - [Download](#download)
  - [Features](#features)
...
* [Developer Guide](development.md)
  - [Setup](development.md/#setup)
    - [System requirements](development.md/#system-requirements)
    - [Pre-Installation](development.md/#pre-installation)
      - [Git](development.md/#git)
      - [Node.js](development.md/#node-js)
      - [Node Version Manager](development.md/#node-version-manager)
      - [Watchman](development.md/#watchman)
      - [React Native CLI](development.md/#react-native-cli)
