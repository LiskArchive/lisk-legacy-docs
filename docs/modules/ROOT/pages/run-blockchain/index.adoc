...
This is covered in more detail, together with the necessary conditions required, which can be found on the xref:{url_enable_block_gen}[Enable block generation page].
