...
To invoke an endpoint via node CLI, simply use the `endpoint:invoke` command as shown in the following code snippet.
...
For further details please see the {url_readme}[Configuring Lisk Node] section in the Readme file.
