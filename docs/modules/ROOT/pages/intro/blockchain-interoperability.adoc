...
The Lisk interoperability solution facilitates communication with other Lisk chains via the concept of xref:{url_cross_chain_cert}[cross-chain] certification.
