...
If you feel like it, play around a little more with the NFT app by creating more NFTs and accounts.
...
We will use both APIs and their provided endpoints to retrieve the following data:
