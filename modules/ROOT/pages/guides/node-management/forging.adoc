...
Forging in xref:{url_protocol_dpos}[DPoS] networks is the same as mining in a Proof of Work (PoW), network which is the process of adding new blocks to the chain.
