...
The Faucet plugin is a useful tool to use in glossterm:devnet["A blockchain network for development purposes. The Lisk SDK provides dedicated genesis block and configurations to conveniently set up a local network during development of a blockchain application."]s or testnets.
