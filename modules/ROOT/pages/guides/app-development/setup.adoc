...
How to create a new blockchain application with the xref:{url_lisk_sdk}[Lisk SDK].
...
The xref:{url_lisk_sdk}[Lisk SDK] will run on both the Ubuntu and MacOS operating systems shown below:
