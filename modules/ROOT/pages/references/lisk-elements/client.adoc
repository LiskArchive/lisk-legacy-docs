...
To import using the ES6 modules syntax, execute the following command below:
...
Alternatively, if using Node.js modules, execute the following command below:
...
Or if it is required, import the specific namespaced functionality by executing the following command below:
