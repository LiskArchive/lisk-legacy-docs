...
At this point it is already possile to start the default blockchain application with runninng `node index.js` in the terminal.
To verify the successful start of the applications, observe the logs in the terminal for possibble errors.
...
** transfer the balannce from the `lostAccount` to the rescuer account and
