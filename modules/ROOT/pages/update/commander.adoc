...
:description: The Commander application update page describes how to upgrade Lisk Core to the latest version via Lisk Commander.
:toc:
:v_core: 2.1.5
...
[TIP]
====
If you have forgotten the name of the Lisk instance, this can be found in the `instances` directory by executing the following command below:
...
Add one or more of the multiple options listed below to the `core:upgrade` command. Multiple options are separated by spaces.
...
For the file naming convention, please refer to the {url_binary_release}[application release].
