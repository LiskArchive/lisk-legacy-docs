...
Please access the Lisk Commander application docs and follow the xref:{url_sdk_commander_setup}[installation instructions].

Once the Lisk Commander application is set up on your system, it is possible to use the commands below to set up and manage your Lisk Core node.
...
Please refer to the {url_binary_download}[application release^] for the file naming convention.
