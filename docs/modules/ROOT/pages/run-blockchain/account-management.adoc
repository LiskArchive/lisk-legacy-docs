...
===== Obtain the Lisk32 address from the hex address
...
Lowercase letters and digits are used, and to improve usability the characters i, l, 1, and 0 have been excluded.
