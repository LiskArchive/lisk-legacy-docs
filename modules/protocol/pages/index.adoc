...
The Lisk Mainnet follows the Lisk SDK protocol.
It has been launched in May 2016 and has a few specificities that are not part of the basic Lisk SDK protocol.
