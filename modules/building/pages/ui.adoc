...
:hide-uri-scheme:
// Project URLs:
:url-project: https://github.com/LiskHQ/lisk-docs/
...
The Lisk Docs UI is a customized fork of the Antora Default UI.
The Antora Default UI is an archetype that demonstrates how to produce a UI bundle that can be used by {url-antora}[Antora] to generated a documentation site.

You can see a preview of the Lisk Docs UI at {url-preview}.
...
The example above clones the Lisk Docs UI project and then switches to the UI folder on your filesystem.
