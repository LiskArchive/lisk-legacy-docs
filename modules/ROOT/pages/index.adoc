...
:glossary-account: An account consists of a unique identifier / xref:{url_glossary_accountaddress}[], an amount of tokens referred to as balance and possibly some additional properties used in other parts of the blockchain application.
