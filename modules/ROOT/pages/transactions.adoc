...
image::delegateRegAsset.svg[DelegateDiagram,width=30%]
...
image::voteAsset.svg[VoteDiagram,width=30%]
...
image::unlockVoteAsset.svg[UnlockVoteDiagram,width=30%]
...
image::multisigRegAsset.svg[MultisigDiagram,width=30%]
...
image::pomAsset.svg[PoMDiagram,width=30%]
