...
In this particular use case, we also need one argument, the namee to resolve.
...
Now as last topic of this tutorial, we'll explore how the application can be tested with unit and network tests.
