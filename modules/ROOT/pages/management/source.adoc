= Lisk Core Source Command reference
...
[TIP]
====
For creating xref:index.adoc#_snapshots[snapshots] in the most convenient manner, it is recommended to use Lisk Core from the xref:binary.adoc#_create_snapshot[binary distribution].
