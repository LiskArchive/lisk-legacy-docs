...
TIP: For a complete list of all default transaction types, please see the section xref:{url_lisk_protocol_transactions}[Lisk Protocol transactions] of  the xref:{url_lisk_protocol}[Lisk Protocol].
