...
When the data is retrieved from the database by a module or plugin of the xref:{url_sidechain_glossary}[Sidechain application], it is returned as a JavaScript object or JSON, depending on the context:
