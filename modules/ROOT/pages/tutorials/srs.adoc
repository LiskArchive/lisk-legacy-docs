...
Try to re-implement the different HTTP API endpoints as actions in the module, and invoke those actions in the frontend to create and post the different transaction types.
