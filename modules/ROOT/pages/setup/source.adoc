...
[NOTE]
====
During this step it is possible to change your port if you wish to have more PostgresSQL instances in the future.
...
NOTE: In case of an `EACCES` error, it is recommended to check the following: https://docs.npmjs.com/resolving-eacces-permissions-errors-when-installing-packages-globally[Resolving EACCES permissions errors when installing packages globally^].
