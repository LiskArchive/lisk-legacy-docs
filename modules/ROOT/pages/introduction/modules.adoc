...
:url_intro_bapps_offchain: introduction/plugins.adoc
...
Actions and Events are exposed to the xref:{url_intro_bapps_offchain}[] and to external services.
...
//TODO: Update description of account schema
== Account schema
