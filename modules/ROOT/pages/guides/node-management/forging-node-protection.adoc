...
UFW is included by default on Ubuntu and can be used to that purpose.
An example using `firehol` can also be found below.
...
[source,bash]
----
sudo apt-get --assume-yes install firehol
----
