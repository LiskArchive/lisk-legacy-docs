...
NOTE: To view the pre-defined default config values, please see the {url_reference_config}[list of configuration options].
...
The configuration object `configDevnet` possesses the structure as shown in the {url_reference_config}[list of configuration options].
...
Check the reference for a complete list of {url_reference_config}[all the available configuration options of the Lisk SDK].
