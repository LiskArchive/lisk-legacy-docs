...
:description: The Lisk Core migration page covers how to migrate the node if a new update introduces a hard fork, together with details on Lisk Bridge and utility scripts.
:toc:
