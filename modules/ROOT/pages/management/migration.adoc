...
See two example videos below, how to vote with Lisk Desktop 2.0.0:
...
Use the Lisk Core CLI to cast the self-vote with the desired amount of tokens from thr command line.
