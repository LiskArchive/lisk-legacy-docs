...
NOTE: To view the predefined default config values, have a look at the <<_list_of_configuration_options,list of configuration options>>
...
The configuration object `configDevnet` has the structure like shown in the <<_list_of_configuration_options,list of configuration options>>.
...
To change them, override the specific default values with custom ones, when initializing the application, like described in as described in <<_modify_default_values,Modify default values>>.
...
TIP: To see a full list of all constants and their predefined values, check out the file https://github.com/LiskHQ/lisk-sdk/blob/development/framework/src/controller/schema/constants_schema.js[framework/src/controller/schema/constants_schema.js].
