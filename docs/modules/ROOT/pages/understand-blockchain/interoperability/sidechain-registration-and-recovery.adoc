...
When this happens, a "terminated sidechain" CCM is emitted by the mainchain, targeting the original sending chain.
When this message is processed, the chain is also terminated on the sending chain, blocking future messages.
...
The "outbox root" substore is initialized on the respective chain as part of the <<sidechain-registration>> process.
...
The chain substore is initialized on the respective chain as part of the <<sidechain-registration>> process.
...
The channel substore is initialized on the respective chain as part of the <<sidechain-registration>> process.
...
The "chain validators" substore is initialized on the respective chain as part of the <<sidechain-registration>> process.
...
Entries are created as part of the <<sidechain-registration-on-the-lisk-mainchain>>.
