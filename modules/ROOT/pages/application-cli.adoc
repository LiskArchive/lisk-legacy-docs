...
=== console
Lisk interactive {url_read_eval_print_loop}[REPL] session to run commands.
...
=== account
Commands related to the accounts of a blockchain application.
...
=== blskey
Commands related to {url_BLS}[BLS] keys.
