...
:url_github_hello: https://github.com/LiskHQ/lisk-sdk-examples/tree/{v_sdk}/hello_world
:url_github_hello_client: https://github.com/LiskHQ/lisk-sdk-examples/blob/{v_sdk}/hello_world/react-client
:url_github_hello_index: https://github.com/LiskHQ/lisk-sdk-examples/tree/{v_sdk}/hello_world/index.js
:url_github_hello_tx: https://github.com/LiskHQ/lisk-sdk-examples/blob/{v_sdk}/hello_world/transactions/hello_transaction.js
:url_github_sdk_config: https://github.com/LiskHQ/lisk-sdk/blob/v4.0.0/sdk/src/samples/config_devnet.json
