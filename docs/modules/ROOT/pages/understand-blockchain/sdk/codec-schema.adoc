...
When the data is retrieved from the database by a module or plugin of the Sidechain application{fn_sidechain_glossary}, it is returned as a JavaScript object or JSON, depending on the context:
