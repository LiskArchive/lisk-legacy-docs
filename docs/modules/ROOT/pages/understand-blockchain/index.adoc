...
:url_references_cli: {docs_sdk}reference/application-cli.adoc
:url_references_commander: {docs_sdk}reference/lisk-commander/index.adoc
:url_references_dashboard_plugin: {docs_sdk}plugins/dashboard-plugin.adoc
:url_references_test_suite: {docs_sdk}reference/lisk-framework/test-suite.adoc
// Project URLs
:url_advanced_communication: understand-blockchain/endpoints.adoc
:url_advanced_architecture_application: understand-blockchain/architecture.adoc#application
...
:url_introduction_module: understand-blockchain/modules-commands.adoc
:url_introduction_plugin: understand-blockchain/plugins.adoc
...
:url_references_http_plugin: {docs_sdk}references/lisk-framework/http-api-plugin.adoc
:url_references_forger_plugin: {docs_sdk}references/lisk-framework/forger-plugin.adoc
:url_references_monitor_plugin: {docs_sdk}references/lisk-framework/monitor-plugin.adoc
:url_references_report_misbbehavior_plugin: {docs_sdk}references/lisk-framework/report-misbehavior-plugin.adoc
:url_references_dpos_module: {docs_sdk}references/lisk-framework/dpos-module.adoc
:url_references_keys_module: {docs_sdk}references/lisk-framework/keys-module.adoc
:url_references_sequence_module: {docs_sdk}references/lisk-framework/sequence-module.adoc
:url_references_token_module: {docs_sdk}references/lisk-framework/token-module.adoc
...
** xref:{url_guides_dashboard}[]: Communicate conveniently with your blockchain application during development via a dashboard.
