...
link:votersresource.md[VotersResource]
...
* link:votersresource.md#constructor[constructor]

==== Properties

* link:votersresource.md#apiclient[apiClient]
* link:votersresource.md#get[get]
* link:votersresource.md#path[path]

==== Accessors

* link:votersresource.md#headers[headers]
* link:votersresource.md#resourcepath[resourcePath]

==== Methods

* link:votersresource.md#handleretry[handleRetry]
* link:votersresource.md#request[request]

=== Constructors

==== constructor

+ *new VotersResource*(`+apiClient+`: link:apiclient.md[APIClient]):
_link:votersresource.md[VotersResource]_

_Overrides void_

_Defined in
https://github.com/LiskHQ/lisk-sdk/blob/e48ce8907/elements/lisk-api-client/src/resources/voters.ts#L23[resources/voters.ts:23]_
...
*Returns:* _link:votersresource.md[VotersResource]_
...
_Defined in
https://github.com/LiskHQ/lisk-sdk/blob/e48ce8907/elements/lisk-api-client/src/resources/voters.ts#L22[resources/voters.ts:22]_
