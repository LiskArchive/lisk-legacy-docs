...
This is performed by the Dynamic Rewards module, whose main purpose is to compute the block rewards according to the validator weight for active validators:
