...
.Anatomy of a module
image::understand-blockchain/sdk/module.png[,600, align="center"]

== The module class

Each module is constructed as a class which extends from the **BaseModule**.

The `BaseModule` provides an interface which needs to be completed by implementing the described components of a module as listed below.
