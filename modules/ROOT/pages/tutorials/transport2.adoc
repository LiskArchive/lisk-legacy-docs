...
Start or restart the `node`, `client` and `iot` application, like you did in xref:tutorials/transport1.adoc#_13_the_client_application[Step 1.3 in Part 1] of the workshop.
