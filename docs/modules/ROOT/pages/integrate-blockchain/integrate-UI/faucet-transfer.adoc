...
Since the faucet allows to seed an account with a specific number of tokens, we require our Hello sApp to also allow transferring tokens both to and from our desired accounts.
