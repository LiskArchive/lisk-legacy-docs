...
class HelloTransaction extends BaseTransaction {
    ...
    */
    applyAsset(store) {
        const errors = [];
        const sender = store.account.get(this.senderPublicKey);
...
let tx =  new HelloTransaction({ <1>
    asset: {
        hello: 'world', <2>
        recipientId: '10881167371402274308L', <3>

    },
    networkIdentifier: 'a59352e01fa66bd4fa270af5d47a8f827c56b36b2d80528b04e1e8ba03134de9', <4>
...
<3> Address of dummy delegate genesis_100.
<4> The network identifier for the devnet.
