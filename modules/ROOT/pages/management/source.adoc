...
If you have one config file existing in any specific version, and you wish to make it compatible with other versions of Lisk, then execute the update config script shown below:
