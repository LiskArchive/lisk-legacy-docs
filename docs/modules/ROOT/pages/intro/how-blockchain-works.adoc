...
- Potential transition to renewable energy: As miners are mindful and well aware of their energy costs, the transistion to deploying renewable energy sources is becoming more and more prevalent
