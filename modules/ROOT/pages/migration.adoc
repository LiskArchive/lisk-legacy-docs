...
:description: How to migrate a node during a hard fork, including details on Lisk Bridge & utility scripts.
:toc:
:page-previous: /lisk-core/v3/interact-with-network.html
