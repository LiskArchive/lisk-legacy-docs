...
----
{
    app:{
        ...
        version: "0.0.0", // version of the application (required)
        minVersion: "0.0.0", // minimal compatible version (required)
        protocolVersion: "1.1", // protocol Version of the application (required)
    ...
    components: {
        logger: { // Contains all options for the logger component.
            fileLogLevel: "info", // Minimum loglevel, that should be logged in the log file.
            logFileName: "logs/lisk.log", // define name and path of the log file.
            consoleLogLevel: "none" // Minimum loglevel, that should be logged in the console, when starting the node. Available values: trace, debug, log, info, warn, error, fatal, none(default).
        },
        storage: { // Contains all options for the storage component.
            ...
            max: 25, // Specifies the maximum amount of database handles.
