...
To run a command in the container where your Lisk Core node is running, please use the following: https://docs.docker.com/compose/reference/exec/[docker-compose exec].
