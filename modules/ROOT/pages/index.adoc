...
*** Many other convenient CLI tools such as creating glossterm:account[An account consists of a unique identifier / address an amount of tokens referred to as balance and possibly some additional properties used in other parts of the blockchain application.]s, encrypting passphrases / messages and more.
