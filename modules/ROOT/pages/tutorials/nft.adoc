...
On the bottom right, there is a bubtton that allows to open the different dialogs for creating a new account, transferring tokens from one account to another and, most importantly, to creating new NFTs.

To be able to create a new NFT, an account needs to have some tokens in the account balance.
