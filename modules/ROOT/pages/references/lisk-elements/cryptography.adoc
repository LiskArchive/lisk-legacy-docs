...
To add the Lisk client as a dependency of your project, execute the following command below:
...
To perform this, expose `NACL_FAST=enable` as the environment variable as shown in the following command below:
