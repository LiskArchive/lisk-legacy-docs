...
[TIP]
====
For creating xref:index.adoc#_snapshots[snapshots] the most convenient way, it is recommended to use Lisk Core from xref:binary.adoc#create-snapshot[binary distribution].
