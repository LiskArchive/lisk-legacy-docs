...
*** xref:understand-blockchain/interoperability/registration-recovery.adoc[]
...
*** xref:build-blockchain/plugin/schema-types.adoc[]
*** xref:build-blockchain/plugin/offchain-db.adoc[]
