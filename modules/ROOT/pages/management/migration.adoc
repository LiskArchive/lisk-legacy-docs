...
:idprefix:
:idseparator: -
:lisk-migrator: lisk-migrator-v1.0.0-linux-x64.tar.gz
// External URLs
...
The announced snapshot heights

//TODO: Add link to mainnet migration blog post
* For Mainnet: `16026074`
* For Testnet: Check the {url_lisk_blog_migration}[Testnet migration announcement^].
