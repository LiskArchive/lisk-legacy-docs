...
.frontend-app/src/utils/transactions/create_nft_token.js
[source,js]
----
/* global BigInt */
...
.frontend-app/src/utils/transactions/purchase_nft_token.js
[source,js]
----
/* global BigInt */
...
.frontend-app/src/utils/transactions/transfer.js
[source,js]
----
/* global BigInt */
...
.frontend-app/src/utils/transactions/transfer_nft.js
[source,js]
----
/* global BigInt */
...
It then uses the `createNFTToken()` function we defined in the <<create-nft>> section to create the NFT and the `sendTransactions()` function from the <<api-related-functions>> section to post the transaction to the blockchain application.
...
It then uses the `purchaseNFTToken()` function we defined in the <<purchase-nft>> section to purchase the NFT and the `sendTransactions()` function from the <<api-related-functions>> section to post the transaction to the blockchain application.
...
It then uses the `transfer()` function we defined in the <<transfer-funds>> section to transfer the tokens and the `sendTransactions()` function from the <<api-related-functions>> section to post the transaction to the blockchain application.
...
It then uses the `transferNFT()` function we defined in the <<transfer-nft>> section to transfer the NFT and the `sendTransactions()` function from the <<api-related-functions>> section to post the transaction to the blockchain application.
