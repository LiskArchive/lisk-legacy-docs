...
In the following guides, it is explained step by step how to create a very simple blockchain application by using the example of the "Hello World" blockchain application, which allows users to save hello messages in their accounts.
