= Lisk SDK Configuration Reference
...
To change them, override the specific default values with custom values when initializing the application, as described in the {url_guide_config}[Modify default values].
