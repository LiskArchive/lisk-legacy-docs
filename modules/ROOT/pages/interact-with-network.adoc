...
Depending on their preferences, node operators may wish to use <<javascript,Lisk Elements>>, <<commandline,Lisk Commander application>> or a graphical interface such as <<lisk_desktop,Lisk Desktop>>.
...
Please see the list of all commands and their example responses on the following: xref:{url_commander_commands}[Commands application page].
