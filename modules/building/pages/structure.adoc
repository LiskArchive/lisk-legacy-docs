...
:url_doc_stagings: https://staginglisk.com/documentation
...
* Task for compiling a new version of the Lisk documentation:
* Task for deploying the latest docs on staging.lisk.com:
