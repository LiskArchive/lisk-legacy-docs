...
* ...a blockchain application that allows offers users the opportunity to recover their accpunts in case they lost their credentials through a social recovery system.
