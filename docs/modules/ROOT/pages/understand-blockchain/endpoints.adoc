...
:url_references_elements_apiclient: reference/lisk-elements/api-client.adoc
:url_references_elements_client: {sdk_docs}reference/lisk-elements/client.adoc
:url_references_plugins_monitor: {sdk_docs}reference/lisk-framework/monitor-plugin.adoc
