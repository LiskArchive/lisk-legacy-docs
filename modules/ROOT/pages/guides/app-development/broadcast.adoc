...
:url_lts_glossary: references/glossary.adoc#lts
...
Ensure that Node.js is the latest xref:{url_lts_glossary}[LTS] (version 12 or higher), and create a Node.js project by creating a `package.json` file inside of your current folder.
