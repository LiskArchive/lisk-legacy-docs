...
:description: Technical references for the Dapps endpoints of the API Client package of Lisk Elements, including usage examples, parameters & example responses.
:toc:
:v_core: 3.0.0
