...
:url_custom_transaction: tutorials/index.adoc
...
For information on creating your own custom transaction, please xref:{url_custom_transaction}[follow the tutorials].
...
Furthermore, the Lisk SDK xref:{custom_transaction}[tutorials] include simple code examples of custom transaction types.
