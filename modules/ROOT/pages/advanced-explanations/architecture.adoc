...
The colored boxes illustrated in the diagram below are the steps exposed to the developer, via the base module and base asset, see the xref:{url_references_framework_basemodule}[Lisk Framework reference].
