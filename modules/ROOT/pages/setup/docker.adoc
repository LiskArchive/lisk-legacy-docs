...
To do this, create a custom configuration file, for example by copying one of the default config files:
...
`--api-ws` enables the WebSocket API of the node, if not already enabled in the config.json.
