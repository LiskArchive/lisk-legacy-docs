...
:glossary-accountaddress_title: account address
...
=== `app:getAccount`
Gets information about an account based on its glossterm:{glossary-accountaddress_title}[Description for account address].
