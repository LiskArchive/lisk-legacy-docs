...
:description: The Lisk Framework overview provides a high-level overview of the Lisk Framework architecture, its modules and components, how they communicate and how to change the default configuration.
:toc:
