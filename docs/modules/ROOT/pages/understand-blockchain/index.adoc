...
**Applications built with Lisk blockchains are called "blockchain applications".**
...
Other components of the application that are not part of the three blockchain domains, like the Transaction Pool, etc. can be implemented differently by the developer if desired, without breaking the protocol.
