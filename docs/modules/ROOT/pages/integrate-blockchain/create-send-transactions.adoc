...
:url_migration_guide: lisk-sdk/v6/references/migration.adoc
...
==== By invoking the action `txpool_postTransaction`
    ...
    "events": [
      {
        ...
        "topics": [
          ...
          "lskdwsyfmcko6mcd357446yatromr9vzgu7eb8y99", (This needs to be updated- Sameer)
          "0000000000000000",
          "lskdwsyfmcko6mcd357446yatromr9vzgu7eb8y99" (This needs to be updated- Sameer)
        ],
        "height": 10
