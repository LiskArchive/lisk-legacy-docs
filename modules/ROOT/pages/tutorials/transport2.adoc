...
TIP: How to replace the genesis delegates with real delegates is covered in the next section <<_replace_dummy_delegates_with_real_ones, Replace dummy delegates with real ones>>.
...
For comparison, this is how the setup was before:

image:one_node.png[One node diagram]

Now we should have the following setup:

image:more_nodes.png[More nodes diagram]
