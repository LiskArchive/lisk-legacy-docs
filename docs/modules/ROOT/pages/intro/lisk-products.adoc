...
The Lisk Core can be defined as the program that actually implements the Lisk protocol. Firstly, the Lisk Core  needs to be installed to enable a node to be run which will then be able to participate in the network
