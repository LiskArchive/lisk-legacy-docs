...
****
As defined on the xref:{url_guides_index_helloapp}[Building blockchain applications with the Lisk SDK] page, the Hello module shall provide the following functionalities:
...
For more information on how to create a command, check out the guide xref:{url_build_command}[].
