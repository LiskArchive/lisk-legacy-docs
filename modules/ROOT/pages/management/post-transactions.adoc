...
To prepare the transaction, create the desired transaction object. To conveniently create the desired transaction object, it is possible to use either the CLI, or to create the transaction with the API client:
