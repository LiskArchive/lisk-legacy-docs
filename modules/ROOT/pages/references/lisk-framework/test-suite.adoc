...
:toc: preamble
// URLs
:url_github_statestor_mock: https://github.com/LiskHQ/lisk-sdk/blob/v5.1.2/elements/lisk-chain/src/testing/mocks/state_store_mock.ts
:url_github_app_env: https://github.com/LiskHQ/lisk-sdk/blob/v5.1.2/framework/src/testing/app_env.ts
