...
Please refer to the section xref:{url_guide_setup_dependencies}[Lisk SDK Dependencies] to set up all the required dependencies to follow this tutorial, if you haven't done so alrerady.
