...
certificate:: Aggregates certificate of a set of the current validators of the sending chain, verifying the correctness of the data sent in the CCU.
It must be a certificate with an adequate BLS signature.
...
inbox:: The `inboxUpdate` contains the information relative to the messages to be included in the sending chain inbox.
