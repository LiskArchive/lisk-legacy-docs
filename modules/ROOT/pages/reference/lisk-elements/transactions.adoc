...
<1> The network identifier of the network, you want to post the transaction to.
...
It is also possible to get the minimum fee for this particular trasnaction, to be accepted by the network:
...
Verifies if an account has enough remaining balance in the account.
