...
:url_guides_non_forging_protection: guides/node-management/non-forging-node-protection.adoc
...
The currently used configuration of a blockchain application is stored under the following path after the application was started for the first time:
