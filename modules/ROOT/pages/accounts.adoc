...
:url_appendix_user_friendly_address: appendix.adoc#user-friendly-address
:url_blocks_forgers: blocks.adoc#block-forgers
:url_consensus_dpos: consensus-algorithm.adoc#lisk-delegated-proof-of-stake
:url_transactions_balance_transfer: transactions.adoc#balance
