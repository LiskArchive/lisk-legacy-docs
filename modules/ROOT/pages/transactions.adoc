...
|*multisignature group registration*|Register a multisignature group in the account
|*delegate misbehavior report*|Report a proof-of-misbehavior of a delegate
|===
...
The 6 different transactions available in the Lisk protocol are listed in the table displayed above.
...
This transaction reports a proof of misbehaviour of a certain delegate.
