...
The whole system is based on Microservices and the several microservices can be delivered using the existing technical stack, whereby each one of them provides a specific functionality.
The actual data is served in JSON format and exposed by a public RESTful API.
