...
The default application does not include any plugins by default, however, the SDK is bundled with a few common plugins listed below, which can be directly imported from the xref:{url_lisk_sdk}[Lisk SDK]:
