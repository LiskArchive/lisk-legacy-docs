...
[IMPORTANT]
====
If you are using the Docker distribution, Lisk Core is configured slightly different.
...
[tabs]
====
(recommended) Pass options as ENV variables::
+
--
...
--
(deprecated) Pass options as flags::
+
--
