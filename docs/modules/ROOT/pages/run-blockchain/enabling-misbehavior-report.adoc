...
:url_consensus_bft: https://github.com/LiskHQ/lips/blob/1e27a5ba99a55d71e6d83f44b6e21f18dda98741/proposals/lip-0014.md
:url_consensus_bft_punishment: https://github.com/LiskHQ/lips/blob/1e27a5ba99a55d71e6d83f44b6e21f18dda98741/proposals/lip-0024.md
:url_rep_mis_transaction: https://github.com/LiskHQ/lips/blob/1e27a5ba99a55d71e6d83f44b6e21f18dda98741/proposals/lip-0057.md#report-misbehavior
...
Using this guide, the Report Misbehavior plugin can be registered to a xref:{url_core_index}[Lisk Core] or a xref:{url_guides_setup}[Hello World application] node, though the steps mentioned below can be applied to any Lisk-based blockchain client.

== Plugin registration
With the latest version of Lisk Core v4 and Lisk SDK v6, the default plugins come pre-installed after an client is installed or initiated, respectively.

For a sidechain, you can check the `package.json` file of the blockchain client to ensure the installation.
...
For a *sidechain*, It is possible to register the plugin through the `plugins.ts` file.
...
+
--
It is possible to enable the Report Misbehavior plugin without updating the configuration, the `plugins.ts` file, or using PM2.
