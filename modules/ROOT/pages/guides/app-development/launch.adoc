...
:description: How to publish a blockchain application, including the components, seed nodes, creating a new genesis block & config objects and adding nodes is described here.
:toc:
...
:url_github_hello_index: https://github.com/LiskHQ/lisk-sdk-examples/blob/v4/hello_world/index.js
:url_github_hello_client: https://github.com/LiskHQ/lisk-sdk-examples/tree/v4/hello_world/react-client
:url_github_hello_package: https://github.com/LiskHQ/lisk-sdk-examples/blob/v4/hello_world/package.json
:url_github_hello_transaction: https://github.com/LiskHQ/lisk-sdk-examples/tree/v4/hello_world/transactions
...
The default options for modules are located in: +
`framework/src/modules/MODULE_NAME/defaults/config.js`. +
The default options for components are located in: +
...
To join the network as a new delegate, follow the steps below:
