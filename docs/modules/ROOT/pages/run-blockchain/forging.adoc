...
=====
Option A - Enable forging with the application CLI::
+
--
...
--
Option B - Enable forging via the application action::
+
--
...
=====
Option A - Disable forging with the application CLI::
+
--
.Disable forging
[source,bash]
...
====
--
Option B - Disable forging via the application action::
+
--
