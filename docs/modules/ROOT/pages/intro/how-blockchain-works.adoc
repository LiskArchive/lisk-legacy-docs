...
:url_dpos: https://www.geeksforgeeks.org/delegated-proof-of-stake/
...
In addition, PoS is more energy efficient than PoW, which means new blocks can be added to the chain with nearly no effort / energy required.
