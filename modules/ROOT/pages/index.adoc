...
:description: The Lisk Core overview gives an introduction about Lisk Core and what is needed to run a node in the Lisk network. It describes the different networks, distributions and the general technology stack of Lisk Core.
:toc:
