...
:url_elements_buffer: references/lisk-elements/buffer.adoc
...
xref:{url_elements_api}[api-client], xref:{url_elements_buffer}[buffer], xref:{url_elements_codec}[codec],
