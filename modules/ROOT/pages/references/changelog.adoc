...
:description: This Developer changelog information contains the transaction types, updated genesis block for the devnet, database & API changes, peers, blocks & delegates.
:toc:
