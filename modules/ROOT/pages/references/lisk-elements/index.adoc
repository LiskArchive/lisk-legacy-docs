...
This section describes in a step-by-step approach how to install Lisk Elements for a given distribution.

NOTE: As all packages in Lisk Elements are independent of each other, they can be installed separately.
