...
IMPORTANT: The balances of accounts are saved as **BigInt**(previously `string`) in the Lisk SDK v4.0.0.
...
The minimum balance is a constant that is defined in the `BaseTransaction` class.
