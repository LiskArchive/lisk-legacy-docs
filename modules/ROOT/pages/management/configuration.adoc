...
:url_management_api: {v_sdk}@lisk-sdk::references/lisk-framework/http-api-plugin.adoc
:url_management_forging: management/forging.adoc
:url_management_logging: {v_sdk}@lisk-sdk::guides/node-management/logging.adoc
:url_management_ssl: {v_sdk}@lisk-sdk::guides/node-management/non-forging-node-protection.adoc#ssl-termination
