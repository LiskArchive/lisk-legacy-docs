...
Next, we need to get the blacklist of words from the xref:{url_guides_module_config}[module config], because we will need it in the next step during the command verification.
