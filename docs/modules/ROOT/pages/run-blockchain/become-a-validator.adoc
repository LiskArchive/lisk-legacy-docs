...
[source,bash]
----
lisk-core hash-onion --count "200000" --output "$HOME/hash_onion.json"
----
+
...
[source,bash]
----
echo $( cat "$HOME/hash_onion.json" | jq --arg x lskqaxxmj78frvgpjgwvf4yqjjkcrr9yhn2sxxwm3 '. + {address: $x}' ) > "$HOME/hash_onion.json"
----
+
...
[source,bash]
----
lisk-core endpoint:invoke random_setHashOnion --file "$HOME/hash_onion.json"
----
+
...
[source,bash]
----
lisk-core endpoint:invoke random_setHashOnion '{"address":"lskqaxxmj78frvgpjgwvf4yqjjkcrr9yhn2sxxwm3","seed":"2aa20ce749838a5c6bac8bdf14dcebd8","count":1000000,"distance":1000}'
----
====
...
[source,bash]
----
lisk-core endpoint:invoke random_getHashOnionSeeds '{"address":"lskqaxxmj78frvgpjgwvf4yqjjkcrr9yhn2sxxwm3"}' --pretty
----
--
Sidechain node::
+
...
[source,bash]
----
./bin/run endpoint:invoke random_getHashOnionSeeds '{"address":"lskqaxxmj78frvgpjgwvf4yqjjkcrr9yhn2sxxwm3"}' --pretty
----
--
=====
