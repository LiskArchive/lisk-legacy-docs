...
:url_commander_commands: reference/lisk-commander/commands/index.adoc
:url_commander_config: reference/lisk-commander/commands/index.adoc#config
...
* Create accounts.
* Get delegates.
* And much more.. For further details please see the following link: xref:{url_commander_commands}[View all commands]
...
TIP: For a full reference of all commands and their available options, please see the following link: xref:{url_commander_commands}[Command Reference].
