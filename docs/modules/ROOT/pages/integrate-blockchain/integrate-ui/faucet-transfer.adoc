...
function Faucet() {
    ...
    const handleSubmit = async (event) => {
        ...
        // 2. This is the passphrase of the hello_client since we are using the first account of the hello_client. Replace this with your own passphrase if you 'init' the application yourself.
