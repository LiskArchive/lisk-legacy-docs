...
image:integrate-blockchain/multisig/01-register.png[]

.Define required signatures and group members
image:integrate-blockchain/multisig/02-add-keys.png[]

.Verify correct parameters
image:integrate-blockchain/multisig/03-verify.png[]

.Sign the transaction
image:integrate-blockchain/multisig/04-sign.png[]

.Share the transaction
image:integrate-blockchain/multisig/05-share.png[]
