...
For a delegate to cast a vote they are required to specify how much Lisk will be voted or unvoted with each vote.
...
In addition, the weight of a delegate will determine the sum of all votes for this delegate.
Hence, to maintain a secure and effective setup, the delegate weight is bound to 10 times the self-votes.
