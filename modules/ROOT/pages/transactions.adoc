...
image::baseTransaction.svg[TxDiagram,width=339,height=310]
...
image::balanceTransferAsset.svg[BalanceTDiagram,340,211]
...
image::delegateRegAsset.svg[DelegateDiagram,332,151]
...
image::voteAsset.svg[VoteDiagram,736,192]
...
image::unlockVoteAsset.svg[UnlockVoteDiagram,765,202]
