...
<47> Port to host the Lisk Wallet on, default is 443 but is recommended to use a port above 1024 with IP tables.
...
<56> Time to wait for response from server before timing out.
