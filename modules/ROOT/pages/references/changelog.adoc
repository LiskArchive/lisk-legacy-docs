...
Once the account is registered as a multisignature account, every outgoing transaction requires as signature for every public key in `mandatoryKeys`.
...
[TIP]
====
New accounts always always with a nonce equal to 0.
