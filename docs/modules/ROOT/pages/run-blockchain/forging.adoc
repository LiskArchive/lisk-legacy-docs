...
The command returns a list of delegates, based on the list under `forging.delegates` in the Lisk Core config, (based on the details added to the config in the previous step, <<add-delegate-data-to-config>>).
