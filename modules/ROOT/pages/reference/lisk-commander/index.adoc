...
:user_guide_commands: lisk-commander/user-guide/commands.adoc
:user_guide: lisk-commander/user-guide.adoc
...
* Create accounts.
* Get delegates.
* And many more.. For further details please see the following link: xref:{user_guide_commands}[View all commands]
...
To see usage examples and configuration options, check the xref:{user_guide}[Lisk Commander User Guide].
