...
This guide explains how to migrate a Lisk Core 2.1.6 node to Lisk Core 3.0.0 with the Lisk migrator.

The Lisk migrator script will generate a new genesis block for Lisk Core 3.0.0.
