...
A reference of all RPC endpoints and events provided by a blockchain client through the Lisk Framework.
...
Lisk node endpoints are public and can be invoked via RPC.
...
=== App
==== `app_getRegisteredAction`
Lists all endpoints in the App.
...
--data-raw '{
    "jsonrpc": "2.0",
    "id": "1",
    "method": "app_getRegisteredEventss",
    "params": {}
}'
----
--
...
Lists all the events in the App.
...
--data-raw '{
    "jsonrpc": "2.0",
    "id": "1",
    "method": "app_getRegisteredActions",
    "params": {}
}'
----
--
