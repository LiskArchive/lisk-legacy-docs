...
:description: The Lisk Core Migration page describes how to migrate the node, if a new update introduces a hard fork in the network. It also provides background information about what exactly is happening during a migration.
:toc:
