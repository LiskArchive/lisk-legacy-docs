...
For more information about the available Lisk Core commands, check the xref:{url_reference_config}[config reference].
...
NOTE: The Lisk Core node needs to run in order to create transactions.
