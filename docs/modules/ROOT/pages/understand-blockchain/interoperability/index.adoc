...
:url_understand_sidechainlifecycle: understand-blockchain/interoperability/sidechain-registration-recovery.adoc
// footnotes
...
To become a sidechain in the Lisk ecosystem, a blockchain application needs to perform the following two simple steps:
