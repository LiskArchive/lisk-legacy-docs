...
To do that, you can regenerate a genesis block for various use cases, such as assigning different tokens to specific addresses of your choice.  You can also recreate the genesis block based on the needs of modules, for example, setting up the initial constraints required for a staking module, etc.
