...
The more complex the logic inside the custom transactions, the more complicated it becomes to verify that the custom transaction object logic is working as expected.
