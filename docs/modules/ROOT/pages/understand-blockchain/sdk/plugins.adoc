...
* The {url_github_hello_plugin}[Hello plugin^] from the xref:{url_guides_setup_helloapp}[Hello] client.
...
It's worth noting that the directory structure of a plugin can be customized as per the requirement of the blockchain application.
