...
Blocks and transactions can be decoded conveniently with the `@liskhq/api-client` library of the Lisk SDK.
...
Assuming you wish to encode or decode a block with the ID `6533da00cec82c6d22b1c12f6cb4b6178fbfd9530e35d1018fcf4585085ec9c6`, then execute the script with the block ID as the parameter:
