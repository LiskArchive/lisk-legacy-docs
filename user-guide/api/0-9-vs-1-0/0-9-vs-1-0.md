...
Metadescription: In this section of the Lisk Documentation we provide a comparison for Lisk Core API version 1.0 vs. 0.9.

----

Metakeywords: Lisk Core API comparison
...
Htmltitle: Lisk Core - User Guide - API - 0.9 vs 1.0 | Lisk Documentation

----

Opengraphtitle: Lisk Core API 1.0 vs. 0.9
