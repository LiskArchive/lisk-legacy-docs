...
:url_module_dpos: {docs_typedoc}lisk-framework/classes/DPoSModule.html
:url_command_register: {docs_typedoc}lisk-framework/classes/DelegateRegistrationCommand.html
:url_command_pom: {docs_typedoc}lisk-framework/classes/ReportDelegateMisbehaviorCommand.html
:url_command_unlock: {docs_typedoc}lisk-framework/classes/UnlockCommand.html
:url_command_genkey: {docs_typedoc}lisk-framework/classes/UpdateGeneratorKeyCommand.html
:url_command_vote: {docs_typedoc}lisk-framework/classes/VoteCommand.html
:url_mpi_getdelegate: {docs_typedoc}lisk-framework/classes/DPoSAPI.html#getDelegate
:url_mpi_getvoter: {docs_typedoc}lisk-framework/classes/DPoSAPI.html#getVoter
:url_mpi_isnameavailable: {docs_typedoc}lisk-framework/classes/DPoSAPI.html#isNameAvailable
...
== DPoS module reference

NOTE: The TypeDoc reference opens in a new browser tab

{url_module_dpos}[image:typedoc.png[,25] DPoS module TypeDocs^]

== DPoS module overview
...
!0
!{url_command_register}[Delegate registration^]
!1
!{url_command_vote}[Vote^]
!2
!{url_command_unlock}[Unlock^]
!3
!{url_command_pom}[Report Delegate Misbehavior^]
!4
!{url_command_genkey}[Update Generator Key^]
!===
|Module API
a|
* {url_mpi_getvoter}[getVoter^]
* {url_mpi_getdelegate}[getDelegate^]
* {url_mpi_isnameavailable}[isNameAvailable^]
