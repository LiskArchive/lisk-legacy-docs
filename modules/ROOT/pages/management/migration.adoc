...
[source,bash]
----
curl -o <file name>.SHA256 https://downloads.lisk.io/lisk/main/lisk-migrator.tar.gz.SHA256
----
--
Testnet::
+
...
[source,bash]
----
curl -o <file name>.SHA256 https://downloads.lisk.io/lisk/test/lisk-migrator.tar.gz.SHA256
----
--
====
