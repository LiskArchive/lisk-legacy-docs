...
:page-next: /lisk-core/v2/interact-with-the-api.html
...
:url_protocol_forging: ROOT::understand-blockchain/lisk-protocol/blocks.adoc#forgers
...
NOTE: To learn how to set up a node, please go to the xref:{url_getting_started}[application setup] page.
