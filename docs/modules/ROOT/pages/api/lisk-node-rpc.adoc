...
:url_lisk_codec: https://lisk.com/documentation/lisk-sdk/v6/references/typedoc/modules/_liskhq_lisk_codec.html
...
TIP: A block's `header` can be encoded via {url_lisk_codec}[Lisk Codec^].
