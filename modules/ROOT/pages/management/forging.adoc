...
// Project URLs
:url_sdk_guides_forging: lisk-v3@ROOT::run-blockchain/forging.adoc
:url_sdk_protocol_puninshment: lisk-v3@ROOT::understand-blockchain/lisk-protocol/consensus-algorithm.adoc#punishment
