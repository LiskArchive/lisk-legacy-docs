...
In the root folder of the sidechain application, generate a skeleton for the new command with Lisk Commander.
...
The `execute()` function is the place in the command where the state changes on the sidechain are made.
