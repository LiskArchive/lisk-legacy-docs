...
The example below will proxy both the WebSocket RPC endpoint and the http RPC endpoint by hostname (`http.lisk.example` is a placeholder for whatever your domain is).
