...
In the SRS tutorial, you learn step-by-step how to create a blockchain application which offers users a feature to recover the balance of their accounts in the event whereby their passphrase has been lost or forgotten.
