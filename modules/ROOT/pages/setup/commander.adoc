...
:url_binary_download: https://downloads.lisk.io/lisk/mainnet/
...
:url_commander_installation: commander.adoc/lisk-commander/installation-instructions
:url_commander_liskcore: management/commander.adoc
:url_commander_setup: lisk-commander/index.adoc#_setup
:url_snapshots: index.adoc#snapshots


Setup and manage your Lisk node conveniently with Lisk Commander. xref:{url_commander_setup}[lisk-commander/index.adoc][[_setup]]

// xref:{url_commander_setup}[lisk-commander/index.adoc][[_setup]]
...
If you have already performed these, please proceed to the installation section below:
// <<install, Installation>> chapter.

=== Install Lisk Commander

Head to the Lisk Commander docs and follow the xref:{url_commander_installation}[installation instructions].
...
TIP: See for all available options the Lisk Commander xref:{url_commander_liskcore}[Command reference for Lisk Core] as well as the xref:{url_commander_liskcore}[General Command Reference].
