...
This section describes how to work with a Docker-based Lisk Core installation, and covers the available basic commands which can be used to manage your Docker-based Lisk node.
