...
:url_validators: {docs-sdk}references/lisk-elements/validator.adoc
...
The Lisk interoperability solution facilitates communication with other Lisk chains built within the Lisk ecosystem, via the concept of cross-chain certification, and deploys the cross-chain bridge methodology as described earlier on this page.
