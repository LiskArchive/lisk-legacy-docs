...
All modules of collectively define the *on-chain logic* of a Lisk application.
...
For example, the method `getAvailableBalance` of the **Token** module is called from the **Interoperability** module at the sidechain registration and command verification step.
