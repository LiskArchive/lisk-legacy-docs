...
:url_statestore: 6.0.0@lisk-sdk::reference/lisk-elements/chain.adoc#state-store
:url_references_token_module: 6.0.0@lisk-sdk::reference/lisk-framework/token-module.adoc
