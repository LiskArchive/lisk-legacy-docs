...
:url_introduction_bapps_defaultmodules: understand-blockchain/index.adoc#default-modules
:url_introduction_bapps_diagram: understand-blockchain/index.adoc#blockchain-application-architecture-diagram
:url_guides_config: build-blockchain/configure-app.adoc
:url_guides_genesis_block: build-blockchain/create-genesis-block.adoc
:url_guides_setup: build-blockchain/get-started.adoc
:url_references_config: {docs_sdk}config.adoc
:url_references_commander: {docs_sdk}reference/lisk-commander/index.adoc
:url_references_elements: {docs_sdk}reference/lisk-elements/index.adoc
:url_references_framework: {docs_sdk}reference/lisk-framework/index.adoc
:url_references_framework_basemodule: {docs_sdk}reference/lisk-framework/index.adoc#the-basemodule
