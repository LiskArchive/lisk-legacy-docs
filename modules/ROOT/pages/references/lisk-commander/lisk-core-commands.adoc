...
:toc:
:v_sdk: v3.0.2
:url_core_setup_binary: lisk-core::setup/binary.adoc
...
[IMPORTANT]
====
The commands for Lisk Core are not compatible with other distributions or with installations from the xref:{url_core_setup_binary}[Lisk Core binary script].
