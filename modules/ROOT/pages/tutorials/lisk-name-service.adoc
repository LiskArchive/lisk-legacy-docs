...
More information about the Dashboard plugin can be found on the reference page of the xref:{url_reference_faucet}[].
...
The following free sitekey and secretkey for reCaptcha can be used for testing purposes: https://developers.google.com/recaptcha/docs/faq#id-like-to-run-automated-tests-with-recaptcha.-what-should-i-do
