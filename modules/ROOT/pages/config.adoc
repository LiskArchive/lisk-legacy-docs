...
TIP: For more information about the configuration schema and configuring and application, see the {url_github_sdk_configschema}[application config schema file^] and {url_configure_app_guide}[How to configure a blockchain application^]. 
