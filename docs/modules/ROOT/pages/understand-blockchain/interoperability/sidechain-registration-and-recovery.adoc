...
:url_bft_weights: glossary.adoc#bft-weight
...
A sidechain is a separate blockchain registered on the mainchain, where the inclusion of a transaction in one of the blockchains can have an effect on the other blockchain.
