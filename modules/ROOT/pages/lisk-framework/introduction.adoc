...
https://jenkins.lisk.io/job/lisk-core/job/development[image:https://jenkins.lisk.io/buildStatus/icon?job=lisk-core/development[Build Status]]
https://coveralls.io/github/LiskHQ/lisk?branch=development[image:https://coveralls.io/repos/github/LiskHQ/lisk/badge.svg?branch=development[Coverage Status]]
http://www.gnu.org/licenses/gpl-3.0[image:https://img.shields.io/badge/License-GPL%20v3-blue.svg[License: GPL v3]]
...
xref:introduction.md[custom configuration options] inside your
blockchain application.
____
