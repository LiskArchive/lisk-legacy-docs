...
:image:lisk_docu_blog_core.png[Logo]
...
When to update, and when to migrate to Lisk Core?
...
* xref:{url_upgrade_binary}[Update Lisk Core Binary]
* xref:{url_upgrade_commander}[Update Lisk Core Commander]
* xref:{url_upgrade_docker}[Update Lisk Core Docker]
* xref:{url_upgrade_source}[Update Lisk Core Source]
