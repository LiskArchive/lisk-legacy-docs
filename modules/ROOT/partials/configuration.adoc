...
<96> The number of milliseconds to ban a peer for, in the case whereby its reputation score falls below 0. <97> How frequently, (in milliseconds) the outbound list is checked and repopulated, (as peers can drop out over a period of time).
