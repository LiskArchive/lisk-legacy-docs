...
:url_snapshots: update/index.adoc#Snapshots
...
:url_upgrade_binary: management/binary.adoc
:url_upgrade_commander: management/commander.adoc
:url_upgrade_docker: management/docker.adoc
:url_upgrade_source: management/source.adoc
:url_getting_started: getting-started.adoc
:url_config_api: configuration.adoc#API_Access_Control
...
- To have the option to xref:{url_config_forging}[Forge][[Forge]] new blocks (assuming you are an active xref:{url_config_forging}[delegate]).
