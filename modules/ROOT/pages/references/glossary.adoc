...
:url_del_misbehavior: dpos-module.adoc#how-to-discover-misbehavior-of-a-delegate
:url_protocol_transactions_pom: protocol/pages:transactions.adoc#pom
:url_dpos: dpos-module.adoc#dpos
:url_delegate_registration: dpos-module.adoc#registering-as-delegate
:url_genesis_block: protocol/pages:blocks.adoc#_genesis_block
:url_reclaim_lsk: protocol/pages:mainnet.adoc#lsk_reclaim
:url_multisignature: protocol/pages:transactions.adoc#multisignature-group-registration
:url_token_transfer: protocol/pages:transactions.adoc#transactions
:url_token_unlock: protocol/pages:transactions.adoc#transactions
