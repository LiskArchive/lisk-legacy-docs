...
[IMPORTANT]
====
The commands for Lisk Core are not compatible with other distributions or with installations from the xref:2.1.0@lisk-core::setup/binary.adoc#_option_b_the_bash_script[bash script].
