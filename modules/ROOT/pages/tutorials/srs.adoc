...
In this example, we use the genesis account for the original account, so it is only necessary to send tokens to the rescuer account and to the 3 friend accounts.
