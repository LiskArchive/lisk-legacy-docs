...
Please note that this approach is only available for passphrases, and not other types of sensitive inputs.
...
Please be aware that this approach is only available for passphrases, and not other types of sensitive inputs.
