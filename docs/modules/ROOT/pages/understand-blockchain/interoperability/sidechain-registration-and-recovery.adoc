...
Therefore, this implies that the corresponding key-value entries for the sidechain are added to the interoperability module store as shown below in Figure 1.  (....LIP 0045 find info on interoperability module store to expalin this a bit...)
