...
<1> Check that the root folder of the Hello_World application is open.
...
IMPORTANT: IMPORTANT: Ensure your node is running, before sending the transaction
...
<1> Navigate into the root folder of the Hello_World application.
