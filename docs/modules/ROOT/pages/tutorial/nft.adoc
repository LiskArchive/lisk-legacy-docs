...
// Project URLs
:url_build_bapp: build-blockchain/create-blockchain-client.adoc#bootstrapping-a-new-blockchain-client-with-lisk-commander
...
The minimum value for it is `1000`, as the other IDs are reserved for future default modules of the Lisk SDK.
