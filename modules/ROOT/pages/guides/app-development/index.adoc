...
:description: This section provides an overview of the application development guides.
:toc:
:imagesdir: ../../assets/images
:url_github_hello: https://github.com/LiskHQ/lisk-sdk-examples/tree/development/hello_world
:url_react: https://reactjs.org/

:url_config: app-development/configuration.adoc
:url_custom: app-development/customize.adoc
...
To set up the Hello World app, first install the xref:{url_config}[prerequisites], then clone the repository and navigate into it as shown below:
