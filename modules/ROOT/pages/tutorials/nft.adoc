...
Move out of the `nft_module` folder back into the `blockchain_app` folder.
...
** a custom module for handeling NFTs
** a custom plugin which adds additional features for the NFTs
