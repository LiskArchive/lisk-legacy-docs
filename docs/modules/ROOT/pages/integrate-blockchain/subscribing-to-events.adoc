...
:url_references_elements_apiclient: {site-url}references/typedoc/modules/_liskhq_lisk_lisk_api_client.adoc
:url_references_elements_client: {site-url}references/typedoc/classes/lisk-elements/client.adoc
// :url_references_elements_client: {sdk_docs}references/typedoc/classes/lisk-elements/client.adoc
