...
While your network is up and running, interact with it and the node through the API and use xref:2.3.2@lisk-sdk::lisk-commander/index.adoc[Lisk Commander] or xref:2.3.2@lisk-sdk::lisk-elements/index.adoc[Lisk Elements] to create sendable transaction objects.
...
See more options on the xref:interact-with-network.adoc[Interact with the network] page.
