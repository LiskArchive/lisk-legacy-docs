...
`topics` are the second property, that can be defined by the developer, when adding/ publishing a blocckhain event.
Topics are similar to tags and labels, categorizing the event after various relevant keywords.
