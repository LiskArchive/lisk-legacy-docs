...
The "Hello World" blockchain application provides the following features:
...
.Salient features of the Hello Lisk application
image::integrate-blockchain/hello-sApp.png["Hello World app overview", 650]