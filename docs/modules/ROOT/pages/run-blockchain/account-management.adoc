...
:url_sdk_guide_txs: integrate-blockchain/create-sign-transactions.adoc
...
TIP: For more information about the available Lisk Core commands, check the CLI references for Lisk Core and xref:{url_sdk_cli}[Lisk SDK].
