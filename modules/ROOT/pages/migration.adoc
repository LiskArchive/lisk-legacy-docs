...
:description: The Migration page describes how to migrate the node if a new update introduces a hard fork in the network, together with additional associated information.
:toc:
