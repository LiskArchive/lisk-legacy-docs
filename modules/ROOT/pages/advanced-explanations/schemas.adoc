...
* *modules* to define the xref:{}[accountSchema], which consists of module-specific properties that are added to each account by the module.
* *assets*, for the xref:{}[schema], which defines the data structure and formats of the transaction asset.
