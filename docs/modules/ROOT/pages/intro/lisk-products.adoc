...
:page-previous: /intro/how-blockchain-works.html
:page-previous-title: How blockchain works
:page-next: /intro/blockchain scalability.html
...
:url_microservices: lisk-service::pages/index.adoc#microservices
:url_restful_api: lisk-service::pages/api/lisk-service-http.adoc
...
It has been designed and built in a manner whereby it can be extended to fulfil the requirements of a wide and diverse range of blockchain use cases.
