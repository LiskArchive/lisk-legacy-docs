...
:url_api_http_testnet:  references/api-testnet.adoc
...
It supports multiple sources to keep the current Lisk token price up-to-date and available to the clients in real time.
