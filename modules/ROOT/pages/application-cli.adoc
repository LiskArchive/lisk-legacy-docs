...
OPTIONS
  ...
  -n, --network=network                                [default: default] Default network config to use. 
                                                       Environment variable "LISK_NETWORK" can also be used.
  ...
  --api-http                                           Enable HTTP communication for api-client. Environment 
...
2022-09-12T14:42:37.574Z ERROR xyz.local engine 24010 [err=Contradicting headers for the block with id: 8e9dae6b2c91e0114473347105ee9c9c9f989324126c09633a0ef05b6bc57b96] Fail to execute block.
----
====
