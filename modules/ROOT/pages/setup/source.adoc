...
.Ubuntu 20
WARNING: If Ubuntu 20 is used, it will install MySQL version 8 by default.
Make sure to install specifically version 5.7 in this case, e.g. by following this guide: {url_mysql_ubuntu20}[^]
