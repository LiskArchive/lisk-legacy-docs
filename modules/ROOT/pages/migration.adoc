...
[IMPORTANT]
====
*Important note for delegates:* After automated upgrade, you still need to enable forging again manually, like described in xref:configuration.adoc#_enable_disable_forging[configuration section].
====
...
* link:#update-config[update_config.js]: migrates config to new structure
