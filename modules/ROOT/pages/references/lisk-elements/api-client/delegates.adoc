...
:description: Technical references regarding the Delegate endpoints of the API client package of Lisk Elements including usage examples, parameters & example responses.
