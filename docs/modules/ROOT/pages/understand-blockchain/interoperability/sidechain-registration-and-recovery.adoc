...
[NOTE]
====
CCM recovery can only be performed from the mainchain.
====
...
The mainchain does not inform other sidechains immediately about a termination.
...
A *terminated state* account is created
