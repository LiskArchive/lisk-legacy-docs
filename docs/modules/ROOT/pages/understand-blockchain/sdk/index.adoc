...
In an *account-based* blockchain, the vaxlidity of a new transaction is checked against a database of user accounts. An account is a portion of the database identified by the account *address*.
