...
Represents the total amount of tokens that the delegates voters voted for this delegate. +
**Example** : `"1081560729258"`|string
|**username** +
...
**Example** : `2`|integer
|**totalAmount** +
__optional__|Total amount of LSK available in the network before the rewards milestone started. +
