...
. link:4-consensus-algorithm.adoc[*Consensus Algorithm*]: In this section illustrates how the delegates eligible to create blocks are selected and how they reach agreement on new blocks.
