...
For example, data like _account balances_, _validator's names_, and _multisignature keys_ are values that are stored in the on-chain module store.
...
Read more about the block lifecycle in the following sections:
