...
[source,bash]
----
curl -o lisk-core.tar.gz https://downloads.lisk.com/lisk/mainnet/3.1.0/lisk-core-v3.1.0-linux-x64.tar.gz
----
...
[source,bash]
----
curl -o lisk-core.tar.gz https://downloads.lisk.com/lisk/mainnet/3.1.0/lisk-core-v3.1.0-darwin-x64.tar.gz
----
--
Testnet::
+
...
[source,bash]
----
curl -o lisk-core.tar.gz https://downloads.lisk.com/lisk/testnet/3.1.0/lisk-core-v3.1.0-linux-x64.tar.gz
----
...
[source,bash]
----
curl -o lisk-core.tar.gz https://downloads.lisk.com/lisk/testnet/3.1.0/lisk-core-v3.1.0-darwin-x64.tar.gz
----
--
====
