...
:url_admin_binary_snapshot: management/application-commands.adoc#create_snapshot
...
:url_setup_docker: setup/docker-image.adoc
:url_setup_source: setup/source-code.adoc
