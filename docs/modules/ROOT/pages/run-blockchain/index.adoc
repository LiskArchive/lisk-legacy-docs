...
:url_sdk_plugin_http: 5.2@lisk-sdk::plugins/http-api-plugin.adoc
...
:url_service_setup_docker_coreconfig: 0.6@lisk-service::setup/docker.adoc#configuring-lisk-core
:url_service_setup_docker: 0.6@lisk-service::setup/docker.adoc
:url_service_setup_source: 0.6@lisk-service::setup/source.adoc
