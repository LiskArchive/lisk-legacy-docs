...
:url_core_network: guides/interact-with-api.adoc
:url_customize: guides/customize-transactions.adoc
:url_customize_basetx: guides/customize-transactions.adoc#interface
