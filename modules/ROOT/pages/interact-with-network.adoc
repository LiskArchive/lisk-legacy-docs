...
:url_commander: configuration.adoc
:url_commander_commands: configuration.adoc#command_line_options
:url_curl: https://curl.haxx.se/
:url_elements: index.adoc
:url_elements_pkg_api: reference/api.adoc
...
For convenience, applications may use wrappers such as xref:{url_elements_pkg_api}[lisk-api-client].
