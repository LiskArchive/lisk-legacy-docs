...
NOTE: The steps explained here are not specific for the Lisk SDK docs and also apply for other documentation components such as `core`, `protocol` and `service`.
...
Use `dev_antora` as the base branch for all pull requests.
