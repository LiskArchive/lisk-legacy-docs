...
:url_elements_api_accounts: reference/lisk-elements/packages/api-client/accounts.adoc
:url_elements_api_blocks: reference/lisk-elements/packages/api-client/blocks.adoc
:url_elements_api_dapps: reference/lisk-elements/packages/api-client/dapps.adoc
:url_elements_api_delegates: reference/lisk-elements/packages/api-client/delegates.adoc
:url_elements_api_node: reference/lisk-elements/packages/api-client/node.adoc
:url_elements_api_peers: reference/lisk-elements/packages/api-client/peers.adoc
:url_elements_api_signatures: reference/lisk-elements/packages/api-client/signatures.adoc
:url_elements_api_transactions: reference/lisk-elements/packages/api-client/transactions.adoc
:url_elements_api_voters: reference/lisk-elements/packages/api-client/voters.adoc
:url_elements_api_votes: reference/lisk-elements/packages/api-client/votes.adoc
...
To add Lisk Client as a dependency of your project, execute the following command below:
