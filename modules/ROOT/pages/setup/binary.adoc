...
rm -rf ~/.nvm
----
Add a new session and set the iTerm to open in the **Intel** mode and then, set a shortcut key for opening iTerm in the aforesaid mode.
...
i386
----
TIP: For installing docker on m1 chips, check out the guide about [Installing on Mac](https://docs.docker.com/desktop/install/mac-install/)
...
----
Install docker for m1 by using google search for “docker install m1” and then run it.
