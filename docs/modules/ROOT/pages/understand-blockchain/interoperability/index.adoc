...
TIP: A full playlist of all videos presenting the full Lisk Interoperability solution can be found on the {url_yt_playlist}[Lisk youtube channel^].
...
To become part of the Lisk blockchain ecosystem, they need to include the Lisk Interoperability module.
...
The chain identifier is defined directly set by the sidechain creator.
...
Then, a user story could look like the example described below:
