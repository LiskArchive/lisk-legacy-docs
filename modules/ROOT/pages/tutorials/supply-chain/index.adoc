...
:description: The Lisk Supply Chain tutorial teaches the user how to build a blockchain application with IoT devices which can communicate with the network.
:toc:
:imagesdir: ../../assets/images
:experimental:
:v_core: 3.0.0
:url_transport_0: tutorials/supply-chain/part1.adoc
