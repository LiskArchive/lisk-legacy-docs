...
:url_lisk_blog_betanet4: https://lisk.io/blog/development/launch-betanet-v4
...
:url_protocol_forging: master@lisk-sdk:protocol:blocks.adoc#forgers
...
NOTE: This version of Lisk Core (3.0.0-beta.1) is currently deployed on the {url_lisk_blog_betanet4}[Lisk Betanet 4^]
