...
Therefore unit tests are generally sufficient to test the functionality of your custom transaction type.
...
Add more improvements like GPS tracking or estimated travel times
