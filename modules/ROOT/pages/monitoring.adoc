...
Suitable for this are all kinds of monitoring softwares that support log analysis, for example, {url_kibana}[Kibana], {url_grafana}[Grafana] or {url_graylog}[Graylog].
