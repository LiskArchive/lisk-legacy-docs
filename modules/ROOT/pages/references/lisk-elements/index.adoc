...
:description: The Lisk Elements overview provides the Lisk Elements library & sub-packages including NPM installation, usage & updates.
...
Lisk Elements is a JavaScript library containing several separately installable NPM packages, each encompassing fundemental components of Lisk related functionalities.
...
Confirm that Node.js and NPM have been successfully installed:
...
[source,bash]
----
npm install lisk-elements@4.0.0
----
...
To update your installation to the latest version of Lisk Elements, simply run the following command(s):
