...
If the multisig-account itself is member of the group, one signature will be appended under signatures, additional to two placeholders for remaining signatures of other members.
