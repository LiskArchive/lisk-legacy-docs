...
To test that the `applyAsset()` function is working as expected, write a unit test, like it is done here: {url_github_hello_world_tx_test}[hello_transaction.test.js^]:
