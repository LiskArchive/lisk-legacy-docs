...
Once Lisk Commander is set up on your system, you can use the commands below to set up and manage your Lisk Core node.
...
See Lisk Core 2.1.5 Commander setup
