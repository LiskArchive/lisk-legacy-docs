...
:description: Part 2 of the Lisk supply chain tutorial describes the implementation, IoT application, & the client application for tracking a packet on the blockchain.
:toc: preamble
:imagesdir: ../../../assets/images
:experimental:
:url_github_transport_alarmtx_solution: https://github.com/LiskHQ/lisk-sdk-examples/blob/v4/transport/transactions/solutions/light-alarm.js
:url_github_transport_alarmtx31: https://github.com/LiskHQ/lisk-sdk-examples/blob/v4/transport/transactions/light-alarm.js#L31
:url_github_transport_index25: https://github.com/LiskHQ/lisk-sdk-examples/blob/v4/transport/iot/light_alarm/index.js#L25
