...
// Project URLs
:url_introduction_modules_accountschema: understand-blockchain/modules-commands.adoc#account-schema
:url_introduction_modules_assetschema: understand-blockchain/modules-commands.adoc#transaction-asset-schema
:url_guides_decode: integrate-blockchain/decoding-transactions-blocks.adoc
