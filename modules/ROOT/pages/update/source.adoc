...
:description: The source code update page describes how to upgrade Lisk Core to the latest version from the source code.
:toc:
...
This section covers how to update Lisk Core from the source code.
