...
:glossary-accountaddress: "Addresses are unique identifiers for accounts in the Lisk blockchain. +
...
An example for an address in Lisk32 representation is `lskxwnb4ubt93gz49w3of855yy9uzntddyndahm6s`. +
...
=== `app:getAccount`
Gets information about an account based on its glossterm:account address[{glossary-accountaddress}].
