...
| P2P
| {url_npm_lisk_passphrase}[@liskhq/lisk-p2p]
...
| Transaction Pool
| {url_npm_lisk_transactions}[@liskhq/lisk-transaction-pool]
| xref:{url_npm_lisk_transaction_pool_docs}[lisk-transactions docs]

| Validator
| {url_npm_lisk_transactions}[@liskhq/lisk-validator]
| xref:{url_npm_lisk_validator_docs}[lisk-transactions docs]
|===
