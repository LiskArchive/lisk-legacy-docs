...
:url_monitoring_logs: {v_core}@lisk-core::monitoring.adoc#log_monitoring

For monitoring or debugging your node, Lisk SDK tracks all activities that occur within the node by creating applicable log messages.
