...
These sidechains can also communicate with other sidechains by utilizing the xref:{lisk_cross_chain_communication}[Lisk Cross-chain communication methodology].
