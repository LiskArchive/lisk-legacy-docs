...
image::baseTransaction.svg[TxDiagram,width=25%]
...
image::balanceTransferAsset.svg[BalanceTDiagram,width=30%]
...
image::delegateRegAsset.svg[DelegateDiagram,width=35%]
...
image::voteAsset.svg[VoteDiagram,width=28%]
...
image::unlockVoteAsset.svg[UnlockVoteDiagram,width=40%]
...
image::multisigRegAsset.svg[MultisigDiagram,width=38%]
...
image::pomAsset.svg[PoMDiagram,width=45%]
