...
[source,bash]
----
curl -o lisk-core.tar.gz https://downloads.lisk.io/lisk/testnet/3.0.0/lisk-core-v3.0.0-linux-x64.tar.gz
----
--
MacOS::
+
...
[source,bash]
----
curl -o lisk-core.tar.gz https://downloads.lisk.io/lisk/testnet/3.0.0/lisk-core-v3.0.0-darwin-x64.tar.gz
----
--
====
