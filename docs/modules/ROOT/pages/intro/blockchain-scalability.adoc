...
[NOTE]
====
The PoS used by Lisk is in fact more of a middle ground between {url_wiki_pos}[PoS] and DPoS.

The PoS-related characteristic is the ability of users to register as validators and then receive stakes from other users, in order to increase their validator weight.
