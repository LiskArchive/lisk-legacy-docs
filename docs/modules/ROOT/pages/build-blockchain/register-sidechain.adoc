...
The processing of this command is designed to create a sidechain account in the mainchain state associated with a unique network identifier and a name.
...
Further details regarding the chain ID can be found xref:{url_chain_id}[here].
