...
:url_types_of_wallets: https://bitpay.com/blog/types-of-crypto-wallets
// Project URLs
...
A more in-depth overview can be found here regarding the xref:{url_types_of_wallets}[types of wallets] in general.
