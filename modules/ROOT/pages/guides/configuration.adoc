...
:url_github_sdk: https://github.com/LiskHQ/lisk-sdk/tree/v3.0.2
...
The default configuration options are located in the {url_github_sdk}[Lisk SDK repository] on GitHub:
...
The Lisk SDK exposes an object `genesisBlockDevnet` that holds all important information to spin up a local development network.
