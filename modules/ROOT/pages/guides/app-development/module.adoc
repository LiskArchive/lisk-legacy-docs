...
:url_guides_setup_helloapp: guides/app-development/setup.adocl#the-hello-world-application
...
[TIP]
====
See the "Lifecycle Hooks" section of the xref:{url_intro_modules_lifecyclehooks}[Modules] introduction page for more information.
====

In the hello module, 2 different lifecycle hooks are defined.
...
TIP: See the xref:{url_advanced_communication}[] page for more information.
