...
:description: All configuration options, constants, and the devnet genesis block which are relevant for configuring a blockchain application cna be found here.
