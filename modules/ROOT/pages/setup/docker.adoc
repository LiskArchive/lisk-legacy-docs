...
docker run -d --volume /data:/home/lisk/.lisk \
    ...
    --name lisk-core lisk/core:3.1.0 start --network=testnet --port 7000\
...
[source,bash]
----
docker run --volume lisk-data:/home/lisk/.lisk -it --rm lisk/core:3.1.0 blockchain:download --network=betanet --output=/home/lisk/.lisk/tmp/
docker run --volume lisk-data:/home/lisk/.lisk -it --rm lisk/core:3.1.0 blockchain:import /home/lisk/.lisk/tmp/blockchain.db.tar.gz
docker run --volume lisk-data:/home/lisk/.lisk -it --rm --entrypoint rm lisk/core:3.1.0 -f /home/lisk/.lisk/tmp/blockchain.db.tar.gz
