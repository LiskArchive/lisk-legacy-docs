...
:url_guide_setup_dependencies: build-blockchain/create-sidechain-app.adoc#dependencies
:url_guide_setup_init: build-blockchain/create-sidechain-app.adoc#initializing-a-new-blockchain-application
