...
:url_enable-forging: management/configuration.adoc#forging
...
Please follow this guide to xref:{url_enable-forging}[enable forging on your delegate node] for further details.
====
