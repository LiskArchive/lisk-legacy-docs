...
In the beginning, this will make the launch of the application a little more complex, but having an independent network comes along with a lot of benefits, which are covered in the following paragraphs.
