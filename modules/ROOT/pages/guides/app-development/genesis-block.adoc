...
They can be used to update the forging information of the genesis delegates in the configuration of the blockchain application. This needs to be done, because each new generation of a genesis block will generate a new random set of genesis delegates.
