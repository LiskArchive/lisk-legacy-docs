...
[source,bash]
----
lisk-core endpoint:invoke pos_getExpectedSharedRewards '{"validatorAddress": "lskzytpy82c8xtkpopchzee3vydza4cvjvcsa4fv3", "validatorReward": "10000", "stake":"100000" }' --pretty
----
