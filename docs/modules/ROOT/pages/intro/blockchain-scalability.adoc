...
Lisk is currently well-placed in this regard, firstly by its use of the DPoS consensus mechanism as explained in more detail in the xref:{url_blockchain}[What is blockchain] page.
