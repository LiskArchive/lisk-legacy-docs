...
:url_commander_commands_createaccount: {docs_sdk}references/lisk-commander/commands.adoc#create-account
...
:url_protocol_genesis_block: understand-blockchain/lisk-protocol/blocks.adoc#_genesis_block
