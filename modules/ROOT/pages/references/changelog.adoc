...
Due to the changes that have been introduced for the structure of transaction objects, the genesis block and its transactions were newly created for the Lisk SDK version 4.0.0
