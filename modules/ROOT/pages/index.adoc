...
The releases for Lisk Core 3.0 will all be published on Betanet first.
...
Read our log post for more information aout the {url_log_core_schedule}[New Lisk Core release schedule]
