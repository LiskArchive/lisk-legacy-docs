...
:description: The Lisk Core Commander application update page describes how to upgrade Lisk Core to the latest version via Lisk Commander.
:toc:
:v_core: 2.1.3
...
Please refer to the {url_binary_release}[application release^] for the file naming convention.
