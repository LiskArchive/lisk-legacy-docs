...
Cryptography plays an import role in blockchain in maintaining security, and is the underlying technology for securing wallets and performing transactions.
