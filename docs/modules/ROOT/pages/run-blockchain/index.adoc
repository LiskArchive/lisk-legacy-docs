...
If starting enabling block generation for the first time, it is highly recommended to firstly check out the dedicated guide: xref:{url_validator}[How to become a validator].
