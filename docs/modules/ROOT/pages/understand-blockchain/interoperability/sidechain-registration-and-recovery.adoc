...
By protocol, the chainID of the mainchain is a constant equal to `0x00000000` in the ecosystem.
...
This command requires the approval of the sidechain validators, as they have to agree on the content of this command and add their aggregate signatures accordingly.
