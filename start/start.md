...
Action                                                            | Description                                                                                                               
 ---------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ 
[Build a blockchain application](build-blockchain-app.md)         | <PRE> - [Alpha SDK step by step guide](build-blockchain-app.md#how-to-build-a-blockchain-application-with-the-lisk-sdk)<br> Step 1 [How to set up the Alpha SDK](build-blockchain-app.md#1-setup-the-sdk)<br> Step 2A [How to configure your blockchain app](build-blockchain-app.md#2-configure-and-customize-the-application)<br> Step 2B [How to register custom transaction types](build-blockchain-app.md#2b-register-custom-transaction-types)<br> Step 3 [How to interact with the network](build-blockchain-app.md#3-interact-with-the-network)<br> - [Hello World! & Cashback tutorials](tutorials.md) </PRE>
