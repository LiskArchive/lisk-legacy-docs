...
[source,bash]
----
curl -o lisk-core.tar.gz https://downloads.lisk.io/lisk/testnet/3.0.0-rc.2/lisk-core-v3.0.0-rc.2-linux-x64.tar.gz
----
--
MacOS::
+
...
[source,bash]
----
curl -o lisk-core.tar.gz https://downloads.lisk.io/lisk/testnet/3.0.0-rc.2/lisk-core-v3.0.0-rc.2-darwin-x64.tar.gz
----
--
====
