...
Firstly regarding the mainchain, the process required is as follows, and is depicted in the illustration in figure 2 below:
...
b. A user can mow recover pending messages with a *message recovery command*.
