...
image::baseTransaction.svg[TxDiagram,scaledwidth="75%"]
...
image::balanceTransferAsset.svg[BalanceTDiagram,scaledwidth="80%"]
...
image::delegateRegAsset.svg[DelegateDiagram,scaledwidth="70%"]
...
image::voteAsset.svg[VoteDiagram,scaledwidth="85%"]
...
image::unlockVoteAsset.svg[UnlockVoteDiagram,scaledwidth="65%"]
...
image::multisigRegAsset.svg[MultisigDiagram,375,204]
...
image::pomAsset.svg[PoMDiagram,330,184]
