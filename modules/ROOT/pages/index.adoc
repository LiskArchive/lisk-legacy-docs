...
The following diagram below provides a high level overview of the architecture:
...
The xref:{url_tutorials}[Tutorial] guides explains in detail how to build a specific blockchain application.
