...
:page-aliases: setup/binary.adoc
:toc:
:v_sdk: master
...
:url_config_api_access: {v_sdk}@lisk-sdk::references/lisk-framework/http-api-plugin.adoc#default-configuration
...
The Application installation is an easy and automated way to set up Lisk Core.
This includes almost completed automated update scripts, together with a selection of tools to assist with seamlessly maintaining a Lisk node.
