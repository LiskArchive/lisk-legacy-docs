...
:description: Technical references for the Delegate endpoints of the API client package of Lisk Elements including usage examples, parameters & example responses.
...
Each of the following methods listed below can be accessed via the `delegates` property of an `APIClient` instance.
