...
The @liskhq/lisk-codec package implements the decoder and encoder using the Lisk JSON schema according to the Lisk protocol.

== Installation

The following command will install the Lisk codec:
