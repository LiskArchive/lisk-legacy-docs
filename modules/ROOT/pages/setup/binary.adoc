...
:url_admin_binary: administration/getting-started.adoc
:url_config: configuration.adoc
:url_config_api_access: pages/configuration.adoc#api_access
...
If you are not running Lisk locally, you will need to follow the xref:{url_config_api_access}[Configuration - API][[api_access]] document to enable access.
...
* Recommended: Set up a xref:{url_config_logrotation}[log rotation][[logrotation]]
