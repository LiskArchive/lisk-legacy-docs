...
It is sufficient to create a group `docker`, and then add the newly created user to that group.
In order to enable the user to use Docker, (see: https://docs.docker.com/install/linux/linux-postinstall/).
=====
