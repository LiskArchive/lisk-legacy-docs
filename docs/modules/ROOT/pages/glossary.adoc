...
:url_delegate_registration: {lisk-docs}run-blockchain/forging.adoc#registering-a-delegate
:url_delegate_registration_tx: {lisk-docs}run-blockchain/forging.adoc#create-the-delegate-registraton-transaction

:url_genesis_block: understand-blockchain/lisk-protocol/blocks.adoc#genesis-block
:url_reclaim_lsk: {docs-core}index.adoc#lsk-reclaim
...
:url_token_transfer: {lisk-docs}understand-blockchain/lisk-protocol/transactions.adoc#transfer
:url_token_unlock: {lisk-docs}understand-blockchain/lisk-protocol/transactions.adoc#unlock
:url_data_structure: {lisk-docs}understand-blockchain/lcodec-schema.adoc#data-types
:url_hash_onion: {docs-sdk}references/lisk-elements/cryptography.adoc#methods-for-the-hash-onion
:url_blockchain_app: build-blockchain/index.adoc
:url_mainnet: lisk-core::index.adoc#mainnet
:url_state_store: {docs-sdk}references/lisk-elements/chain.adoc#state-store-and-database-mechanism
...
An account is an address with an amount of tokens referred to as balance. The address is a unique identifier which has state information associated with it.
