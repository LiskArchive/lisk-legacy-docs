...
:description: The Lisk Core Commander application commands page covers all relevant commands to manage the Lisk Core application with Lisk Commander.
:toc:
...
NOTE: For more information, please see the xref:{url_setup_commander}[Setup page of Lisk Core via Lisk Commander application].
