...
With the latest version of Lisk Core v4, there will be new configurable settings and the following modules listed below in the next sub section will also be used.
...
* Interoperability
- The Interoperability module provides basic functionalities to transmit information between interoperable chains in the Lisk ecosystem using cross-chain messages.
* Token
