...
As an excercise, you could optionally try to implement all HTTP endpoints of the SRS API plugin as plugin actions.
====
...
Now create a new file `index.js` inside the newly created `srs_api_plugin/` folder.
