...
The "Run Blockchain" category contains all the guides concerning the management of a Lisk node and is therefore especially interesting for validators and other operators of a Lisk node.
...
These nodes fulfill a very important role in the network and therefore require certain additional configurations regarding enabling block generation and security measures, compared to regular nodes.
