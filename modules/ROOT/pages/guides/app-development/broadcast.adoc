...
:description: How to create, sign and broadcast a transaction object the network, including how to validate the fee for a transaction.
:toc:
:sectnums:
:v_protocol: master
...
:url_protocol_signature_scheme: {v_protocol}@lisk-sdk:protocol:appendix.adoc#signature_scheme
