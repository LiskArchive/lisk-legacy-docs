...
At this point the entire workflow should be implemented with different packet statuses.
If the the packet is currently `ongoing`  or `alarm`, then to send an alarm follow the instructions described below:
