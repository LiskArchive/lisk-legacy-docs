...
This methodology is highly advantageous as with a partial mesh topology not all nodes are connected to each other, and are only connected to a small group of nodes present in the network.
