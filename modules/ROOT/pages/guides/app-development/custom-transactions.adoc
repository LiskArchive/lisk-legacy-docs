...
To increase your application’s performance, the following functions should be overidden: `MIN_FEE_PER_BYTE`, `NAME_FEE`, `verifyAgainstTransactions`, `assetFromSync`, `fromSync`.
