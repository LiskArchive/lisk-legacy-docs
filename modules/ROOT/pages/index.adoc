...
//Project URLs
:url_blockchain-apps: introduction/blockchain-applications.adoc
...
****
The Lisk SDK is an open-source software development kit which enables developers to build scalable xref:{}[]blockchain applications in JavaScript.
****
